(function (lib, img, cjs, ss) {
  ...
  lib.properties = {
    ...
    color: "#666666",
    manifest: [
      { src: "images/Untitled2.png?1497422705769", id: "Untitled2" },
      { src: "images/Untitled5.png?1497422705769", id: "Untitled5" },
    ],
  };
  ...
  (lib.tree = function (mode, startPosition, loop) {
    ...
    this.shape_1.graphics
      ...
      .ss(1, 1, 1)
      .p(
        "",
      );
    ...
    this.shape_5.graphics
      ...
      .s()
      .p(
        "AnHSaIAnhDQArASBAgCIANAAQBaADBVAsIgUArQgUADgcAAQhdAAitgqgAHIzDIAAADIgBABIABgEg",
      );
    ...
    this.shape_6.graphics
      ...
      .s()
      .p(
        "AnJQ1IAOgYIAlhJQBQAsBcASQApAGArADIgEAKIglBUIgPAmQiRgihqhIgAEsxmIACgMIAHgjQAzAGAzgGQAXgDAYgGIgGAuIgBASQgbACgZAAQg1AAgugKg",
      );
    ...
    this.shape_7.graphics
      ...
      .s()
      .p(
        "AnjT7IA+h4QAFALAHAKQAXAoAtASIgoBEQgwgMg2gPgAFNtfQApioAjiqIAUhkQAaAUAdANIgDAJIhVG4IgTgPIgGgFQgRgPgRgQIgPAzIAAADIgCAAIANgvg",
      );
    ...
    this.shape_9.graphics
      .f("#633911")
      .s()
      .p("AkdQYIAYhBIAtALIgdBDIgogNgADNwbQAlgCArgHIABAkQgsAEgmAAIABgfg");
    ...
    this.shape_10.graphics
      ...
      .s()
      .p(
        "AjYOvIANgrIBFACIgmBeQggADggABQALgdAJgcgACkvUQAggHAmgMIADAoQglAPgkALIAAgvg",
      );
    ...
    this.shape_11.graphics
      ...
      .s()
      .p(
        "Ak8O5IAEgHIAlhcIAHgUQATAKATAIQBQAfBjAIIgNAqQgJAdgLAcIgGAAQh6AAhoglgAC/vMIAAgJIAXABQAwACA2gLIAAAuQhCATg/AAIAEgwg",
      );
    ...
    this.shape_12.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_13.graphics
      ...
      .s()
      .p(
        "AkSPOQghgegcggIAVgtQAuA0A3AoQgDAFgCAGIgQAmIgogigAEyvHQgWgIgVgJIAEgWQAhAPAkAIIAAAGIgCASIgcgIg",
      );
    ...
    this.shape_14.graphics
      .f("#533012")
      .s()
      .p("AkwPDIATgvIAKALIgWAtIgHgJgAD/u1IAFgVQAWANAXALIgEAWQgXgMgXgNg");
    ...
    this.shape_15.graphics
      .f("#522E0E")
      .s()
      .p("Ai9LyIAbhaQAaARAbAPIgiBiQgYgTgWgVgACUrxIABgoIApAHIAAAuQgWgGgUgHg");
    ...
    this.shape_16.graphics
      ...
      .s()
      .p(
        "AlfRtIAQglQACgHADgEIAPAKQBZA8BwAhIgYBAQh4gshdhLgABFHGIgJgBIgIgDQg+gWg7ghIAHgUIAehgQBaAiBbACIgLAxIgVBVQgDAIgBAIQgWgEgWgHgADZtCIACgSIAAgFIAKACQA6AMBBgDIgBAfQhIgBg+gSgADsyhIAAgKIgBgsQA2ABAxgNIADAWIAEAuIgZACIgKABIgGAAQgiAAgigFg",
      );
    ...
    this.shape_17.graphics
      ...
      .s()
      .p(
        "AAfLOIAKg/IgHAwIgDAPIAAAAgAAfLOQg1AAgzgJIAMhLQA1AAA3gQIgGAlIgKA/IAAAAgAAKq2QAcgIAbgPIAIAmIABAGQgdAIgdAEIgGghg",
      );
    ...
    this.shape_18.graphics
      ...
      .s()
      .p(
        "AhSKOIgZgQIgFgDQAGgcAIgbIACACQAQALAQAJIAmATIgNA2IgrgVgABXqGIgUgDIgCgZIAWADIAYADIACAZIgagDg",
      );
    ...
    this.shape_19.graphics
      ...
      .s()
      .p(
        "AhPKHQgVgPgUgQIABgGIAAAAIABgDIAOg0QARARASAOIAGAFIATAQQgIAbgHAbIgUgOgABRp5IgBgEIgCgXQAVAHAUAFIACAZQgVgEgTgGg",
      );
    ...
    this.shape_22.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_23.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_27.graphics
      ...
      .s()
      .p(
        "AlMVfIA4iSIAMAMIAKALIgOAfIgdBCIgRAlIgSgLgADHnBIgOgEIALhLQAVAMAWAJIgGAvIgCASIgggHgAEF1LQAdgNAYgSIATAvQgbAQgcALIgRgrg",
      );
    ...
    this.shape_28.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_29.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_33.graphics
      ...
      .s()
      .p(
        "",
      );
  ...
  (lib.Symbol2 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "Eg//ADZIAAmxMBmLAAAQBjAAABBkIAADpQgBBkhjAAgEA89ACdQAyhGgBhZQAAhgg2hJIDHAAIAAFIgEAzvACdQAxhGABhZQgBhgg3hJICEAAQg4BJABBgQgBBZAyBGgEAqzACdQhkAAAAhkIAAiAQAAhkBkAAIBsAAQg4BJAABgQABBZAxBGg",
      );
  ...
  (lib.tree_Iceland = function (mode, startPosition, loop) {
    ...
    this.shape_2.setTransform(4.4, -44);

    this.shape_3 = new cjs.Shape();
    this.shape_3.graphics.f("#017D3F").s().p("AgBAAIADAAIgBABg");
    this.shape_3.setTransform(1.1, -87.9);
  ...
  (lib.Symbol3 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AO5GJIAAsRMAsbAAAQB9AAAAB9IAAIXQAAB9h9AAgA5hGJIAAsRMAn6AAAIAAMRgEg7XAGJQh5gCAAh7IAAoXQAAh9B9AAMAhTAAAIAAMRg",
      );
  ...
  (lib.fdhf = function (mode, startPosition, loop) {
    ...
    this.shape_5.graphics
      ...
      .s()
      .p(
        "EjhxAFRIB8AAIAA0mIh0AAQARttAytpIAAwPQEkAvE5gSQD8gPDtA/QBAARA2AZQCEgZkRCDQkSCDC6CzQDYAqCEAWQDlAmDuADQFBAEE3gpQEeglErAJIFSAKQBnADkYBKQkYBLCyBKQCxBLgTAHQgUAJCtBvQApAWAuAMIE/AAIBCgFIBIgGIC6gRQAvgDAvgMQCegmCqACQAXAAAYgBQC5gGFmBWMD9UAAAMB09Bi3MnBOACnQiI68gN6ug",
      );
    ...
    this.shape_6.graphics
      ...
      .s()
      .p(
        "AkEAbIgHgCQAAgBAAAAQAAgBAAAAQAAgBABAAQAAgBABAAQBOguHHgBQhWAGhmANQlHAggEACIgJAAg",
      );
    ...
    this.shape_7.graphics
      ...
      .s()
      .p(
        "AnxAHQBmABAngBQDAgEBGgPIAJgBIAHACIF3gCQF3gElFAPQlDAKl7AGIgBAAIgQABQgvAAhOgIg",
      );
    ...
    this.shape_8.graphics
      ...
      .s()
      .p(
        "AmLANQpOgHE9gFQE+gCAAgBIACgDQACgBAFgBQACgBADABQBjAHDiAGQDKAHBNAAQBZAABbgOQBdgSDkAAQAGAAAEACQAAAAAAAAQAAAAAAAAQABAAAAABQAAAAAAAAIgBADIgKABQjaAAhcAPQhiARhdAAQhNAApKgHg",
      );
    ...
    this.shape_9.graphics
      ...
      .s()
      .p(
        "AknAKQkxgKHlAAQHjgCgGgCQgEgCAAgBQAAgBAAAAQAAAAABAAQAAgBABAAQABAAABAAQABgCAFAAQAFAAAFACIAWAGIAOACQkkANjrAAQhfAAhXgCg",
      );
    ...
    this.shape_10.graphics
      ...
      .s()
      .p(
        "Ao7AiQhSgFh2gWQqXgkKiAdQKfAeEXggQEggiDIAAQBcAABWALQBjANCNAfQABABABAAQABAAAAAAQABABAAAAQAAAAAAABIgCADIgGABIgKAAQiHgfgvAKQgwAMicgJQiegIk4ATQk3ASi4AAQj+ABgwgEg",
      );
    ...
    this.shape_11.graphics
      ...
      .s()
      .p(
        "AqpAfQp8gdG7gBIF/gBIgHAAQAAAAgBAAQAAAAAAgBQgBAAAAgBQAAAAAAAAQAAgBAAAAQAAAAABgBQAAAAAAAAQABAAAAAAQAEgCAFAAQA4AADUAGQDQAEAoAAQGUAAETgUQEsgYApAAIAJABIABACIgBADIgZAFQgZAEoQApQlBAZlnAAQjoAAj3gKg",
      );
    ...
    this.shape_12.graphics
      ...
      .s()
      .p(
        "AtaAMQmlgPhIAAIgHgBQgFgCAAgBQAAgBAFgBQACgCAFAAIHpAFIBcACQHlAEGUgUIAngCQCzgKDEAJQVaAjt5gLQt6gJAAABIgCADQhuAhmOAAQgwAAmogRg",
      );
    ...
    this.shape_13.graphics
      .f("#9EE6F2")
      .s()
      .p("Am8gBQgbgiFsAGICsACID3ADQA2AABRAgIhrgUQhXAAjCAUQjDAXhLAAQh4AAhxggg");
    ...
    this.shape_14.graphics
      ...
      .s()
      .p(
        "AH1AAQhIgKi2AAQgtAAkKAKQkOALgqAAQhEAAhhgJQhJgGg9gJQCMgJFhgLQFggLAYgBQEQABA9AEQCUAKAABLQh1glg5gIg",
      );
    ...
    this.shape_15.graphics
      ...
      .s()
      .p(
        "AgZAUIgIgBQlWgKmygDQm2gDimgKIgGgCQgEgBAAgCIAHgCQADgBAFABQClAMGyACQGyACFlgQQFkgTHLAQQHKAQBQgHQBPgGAFAAIAFABIAAAEIgFACQikAXnaAHQjFACiuAAQjxAAjCgFg",
      );
    ...
    this.shape_16.graphics
      ...
      .s()
      .p(
        "AlYASQppgHhYgLQhXgLgCgCQgBAAAAgBQgBAAAAAAQAAgBAAAAQAAAAAAgBQAAAAAAAAQAAgBABAAQAAAAABAAQABgBABAAIAFgBQDmAPKSAAQKPgBLSgOQADAAACACIACABQAAABAAAAQAAABAAAAQgBABAAAAQAAAAgBABQgCABmxARQlFAOmqAAIkpgCg",
      );
    ...
    this.shape_20.setTransform(575.9, 603.6);
    ...
    this.shape_21.setTransform(397.9, 576.3);
    ...
    this.shape_22.setTransform(390.5, 515.8);
    ...
    this.shape_23.setTransform(390.6, 494.7);
    ...
    this.shape_24.setTransform(387.4, 513.8);

    this.shape_25 = new cjs.Shape();
    this.shape_25.graphics
      .lf(["#28CEF5", "#94FBFD"], [0, 1], -2.9, -37.6, 0.3, 200.8)
      .s()
      .p("Ehgtgf2MDBbAAAMAAAA/qIt2AAMieyAADI0zAAg");
    this.shape_25.setTransform(428.2, 204);

    this.shape_26 = new cjs.Shape();
    this.shape_26.graphics
      .lf(["#16B6DB", "#49D9FA"], [0, 1], -1204.9, -225.5, -1204.9, -110.8)
      .s()
      .p(
        "",
      );
    this.shape_26.setTransform(450.5, 642.9);

    this.shape_27 = new cjs.Shape();
    this.shape_27.graphics
      .lf(["#16B6DB", "#49D9FA"], [0, 1], -10194.7, -225.5, -10194.7, -110.8)
      .s()
      .p("EhgtAkwMAAAgjOMAAAgmOMDBbgADMAAABJfg");
    ...
    this.shape_28.graphics
      .lf(["#28CEF5", "#94FBFD"], [0, 1], -2.9, -37.6, 0.3, 200.8)
      .s()
      .p("Ehgtgf2MDBbAAAMAAAA/qMjBbAADg");
  ...
  (lib.Underbg = function (mode, startPosition, loop) {
    ...
    this.shape_1 = new cjs.Shape();
    this.shape_1.graphics
      .lf(["#16B6DB", "#49D9FA"], [0, 1], 4489.7, 846.8, 4489.7, 846.8)
      .s()
      .p(
        "EAIAA//IgGgGICjBhIidhbgEgKchBYIAEgBQAAAAABAAQABAAAAAAQABAAAAAAQABAAAAAAIAGABIgKABIgEgBg",
      );
    ...
    this.shape_15.graphics
      .f("#845744")
      .s()
      .p("AkhAbQA4hEAZgFIFkhgQBcgTAeAvQAHANAEAQIBfDPQlrgslBA6IhEANQAyhLAlgvg");
    ...
    this.shape_17.graphics
      .f("#845744")
      .s()
      .p("ABSAnQhUgRhhANIAZg7IADgIQAJgOAYAGIBeAcQAGABAPASQAKAOANAWIgSgEg");
    ...
    this.shape_28.graphics
      .lf(["#28CEF5", "#94FBFD"], [0, 1], 1031.4, -128.3, 1030.7, 124.1)
      .s()
      .p("EhVJARlIAAi6MAAAggPMCqTAAAMAAAAjJg");
    ...
    this.shape_29.graphics
      ...
      .s()
      .p(
        "",
      );
    this.shape_29.setTransform(5193, 477.6);

    this.shape_30 = new cjs.Shape();
    this.shape_30.graphics
      .lf(["#16B6DB", "#49D9FA"], [0, 1], 3, -296.4, 3, -169)
      .s()
      .p(
        "",
      );
    ...
    this.shape_31.graphics
      ...
      .s()
      .p(
        "",
      );
  ...
  (lib.Symbol8 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      .f("#FFFFFF")
      .s()
      .p("AT9EPIAAodIAgAAIAAIdgA0cEPIAAodIAfAAIAAIdg");
    this.shape.setTransform(-128.7, 0.9);
