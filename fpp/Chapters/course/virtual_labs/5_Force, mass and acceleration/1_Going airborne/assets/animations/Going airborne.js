(function (lib, img, cjs, ss) {
  ...
  lib.properties = {
    ...
    color: "#666666",
    manifest: [
      { src: "images/Untitled2.png?1493106274461", id: "Untitled2" },
      { src: "images/Untitled5.png?1493106274461", id: "Untitled5" },
    ],
  };
  ...
  (lib.tree = function (mode, startPosition, loop) {
    ...
    this.shape_28.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_35.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_36.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_38.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_39.graphics
      ...
      .s()
      .p(
        "",
      );
  ...
  (lib.InstructionText = function (mode, startPosition, loop) {
    ...
    mask._off = true;
    mask.graphics.p("A92EQIAAmdQgBiCCCABMA3qAAAQCDgBgBCCIAAGdg");
    mask.setTransform(-72, -27.2);
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "",
      );
    this.shape.setTransform(-71.9, -25.4);
    ...
    this.shape_1.graphics
      ...
      .s()
      .p(
        "Eg45ADeQ3khcABiCQgBiCXkhcUAXlgBcAhUAAAUAhVAAAAXkABcQXkBcAACCQAACC3kBcUgXkABdghVAAAUghUAAAgXlgBdg",
      );
    ...
    this.shape_2.graphics
      .f("#FFFFFF")
      .s()
      .p("A92EQIAAmdQgBiCCCABMA3qAAAQCDgBgBCCIAAGdg");
    this.shape_2.setTransform(-72, -27.2);

    this.shape_2.mask = mask;

    this.timeline.addTween(cjs.Tween.get(this.shape_2).wait(1));
  }).prototype = p = new cjs.MovieClip();
  p.nominalBounds = new cjs.Rectangle(-263.2, -54.4, 382.4, 54.4);
  ...
  (lib.Symbol2 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "Eg//ADZIAAmxMBdGAAAQBlAAgBBkIAADpQABBkhlAAgEA89ACdQAyhGgBhZQAAhgg2hJIDHAAIAAFIgEA0IACdIgZAAIhNAAQhkAAAAhkIAAiAQAAhkBkAAIBHAAIAlAAIBfAAQg4BJABBgQgBBZAyBGg",
      );
  ...
  (lib.mc_01 = function (mode, startPosition, loop) {
    ...
    this.shape_15.graphics
      ...
      .ss(0.5, 1, 1)
      .p(
        "AAVAAIAcAFIgBAEIgFAeAAVAAIgNgBIgXgFIgbgFIgCANQALgEASAAQALgBAMACAAQgiIALACIgGAgAAQgiIgGgBQgMgCgJAMIACgNIATADAgvAPIADgNAgPgGIABgJQAWgBAIgSAgLgZIgDAKAAtAIQguASgugLAgwAWIABgH",
      );
  ...
  (lib.CoconutTree2 = function (mode, startPosition, loop) {
    ...
    this.shape_2.setTransform(31, -14.5);

    this.shape_3 = new cjs.Shape();
    this.shape_3.graphics.f("#017D3F").s().p("AAAAAIABAAIgBAAIAAAAg");
    this.shape_3.setTransform(32.9, -29);
  ...
  (lib.beachhouse = function (mode, startPosition, loop) {
    ...
    this.shape_9.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_19.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_21.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_24.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_25.graphics
      ...
      .s()
      .p(
        "",
      );
  ...
  (lib.Symbol3 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AMMGJIAAsRMApIAAAQB9AAABB9IAAIXQgBB9h9AAgA43GJIAAsRMAkjAAAIAAMRgEg1YAGJQh5gCABh7IAAoXQgBh9B+AAIb8AAIAAMRg",
      );
    this.shape.setTransform(-131.5, 0);
  ...
  (lib.popup = function (mode, startPosition, loop) {
    ...
    // Layer 1
    this.instance = new lib.InstructionText();
    this.instance.setTransform(72, 93.9);

    this.timeline.addTween(
      cjs.Tween.get(this.instance).to({ y: 27.2 }, 14).wait(1),
    );
  }).prototype = p = new cjs.MovieClip();
  p.nominalBounds = new cjs.Rectangle(-523.1, 39.5, 1030, 84.9);
  ...
  (lib.mc_bg = function (mode, startPosition, loop) {
    ...
    this.shape_7.graphics
      .f("#845744")
      .s()
      .p("AkhAbQA3hEAagFIFjhgQBdgTAeAvQAHANAEAQIBgDPQlrgslCA6IhDANQAxhLAlgvg");
    ...
    this.shape_10.graphics
      .f("#845744")
      .s()
      .p("ABSAnQhUgRhhANIAZg7IAEgIQAHgOAZAGIBeAcQAGABAPASQAKAOANAWIgSgEg");
    ...
    this.shape_12.graphics
      ...
      .s()
      .p("EhVJARlMAAAgjIMCqTAAAMAAAAjIg");
    ...
    this.shape_17.graphics
      ...
      .s()
      .p(
        "AwUEkQkWiiA7i6QAJgeASgeQBsi5F6hvQFPhkGfAAQGfAAFRBkQF5BvBsC5QASAeAJAeQA6C6kVCiQl8DdqZAAQqZAAl7jdg",
      );
  ...
  (lib.mc_backFan = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance)
        .wait(1)
        .to({ regY: 15.7, rotation: -40.5, y: 15.9 }, 0)
        .wait(1),
    );
  }).prototype = p = new cjs.MovieClip();
  p.nominalBounds = new cjs.Rectangle(-0.8, -0.8, 33.5, 33.6);
  ...
  (lib.Symbol8 = function (mode, startPosition, loop) {
    ...
    // Layer 3
    // this.shape = new cjs.Shape();
    // this.shape.graphics.f("#FFFFFF").s().p("");
    // this.shape.setTransform(-131.3,0.8);
    ...
    this.shape_1.graphics
      .f("#FFFFFF")
      .s()
      .p("ASSEPIAAodIAgAAIAAIdgAyxEPIAAodIAgAAIAAIdg");
    this.shape_1.setTransform(-173.7, 0.9);

    this.instance = new lib.Symbol4();
    this.instance.setTransform(-124.9, 0.5);

    this.timeline.addTween(
      cjs.Tween.get({})
        .to({ state: [{ t: this.instance }, { t: this.shape_1 }] })
        .wait(1),
    );
  ...
  (lib.Goingairborne = function (mode, startPosition, loop) {
    ...
    this.instance_4.setTransform(235.4, 707.3, 1, 1, 0, 0, 0, -8.1, 15.3);
