(function (lib, img, cjs, ss) {
  ...
  lib.properties = {
    ...
    color: "#666666",
    manifest: [
      { src: "images/Untitled2.png?1497422616792", id: "Untitled2" },
      { src: "images/Untitled5.png?1497422616792", id: "Untitled5" },
    ],
  };
  ...
  (lib.tree = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .ss(1, 1, 1)
      .p(
        "",
      );
  ...
  (lib.beachhouse = function (mode, startPosition, loop) {
    ...
    this.shape_13.graphics
      ...
      .s()
      .p(
        "ABbDQIgPguIAgAEIgIg7IgtgDIgCgGIAUgLIiRgkIg+j3IANgTIAAAcIAKgJIAHAZIAMAmIAtAEIACASIgrgEIAEARIApADIACAUIglgDIAGAXIAjAEIADAaIgfgDIAEAUICVAOIgBgQIAeABIASDhgABuCnIAAgBIgCAAgAguAsICNAXIgHgcIiNgUgABWghIgBgSIAcAAIABAUgABRhxIAagBIACAdIgaABg",
      );
    ...
    this.shape_21.graphics
      ...
      .s()
      .p(
        "",
      );
  ...
  (lib.Symbol8 = function (mode, startPosition, loop) {
    ...
    this.shape.setTransform(-173.7, 0.9);
  ...
  (lib.mc_Helicopter1_1 = function (mode, startPosition, loop) {
    ...
    this.shape_22.graphics
      ...
      .ss(0.5, 1, 1)
      .p(
        "AguAaIAAgNQALgIARgDQALgCAMAAIgXAAIgcAAIAAANAguAhIAAgHAAHghIALAAIAAAhIAdAAIAAADIAAAeAAHghIgGAAQgMABgHANIAAgOIATAAAgSAAIAAgJQAVgFAEgTAgSgTIAAAKAASAAIgNAAAArADQgrAagugD",
      );
  ...
  // stage content:
  (lib.Whatisthemassofthehelicopter = function (mode, startPosition, loop) {
    this.initialize(mode, startPosition, loop, {});
