(function (lib, img, cjs, ss) {
  ...
  lib.properties = {
    ...
    color: "#FFFFFF",
    manifest: [
      { src: "images/_1.png?1497422666039", id: "_1" },
      { src: "images/_10.png?1497422666039", id: "_10" },
      { src: "images/_2.png?1497422666039", id: "_2" },
      { src: "images/_3.png?1497422666039", id: "_3" },
      { src: "images/_4.png?1497422666039", id: "_4" },
      { src: "images/_5.png?1497422666039", id: "_5" },
      { src: "images/_6.png?1497422666039", id: "_6" },
      { src: "images/_7.png?1497422666039", id: "_7" },
      { src: "images/_8.png?1497422666039", id: "_8" },
      { src: "images/_9.png?1497422666039", id: "_9" },
      { src: "images/Untitled2.png?1497422666039", id: "Untitled2" },
      { src: "images/Untitled5.png?1497422666039", id: "Untitled5" },
    ],
  };
  ...
  p.nominalBounds = new cjs.Rectangle(0, 0, 273, 72);

  (lib._10 = function () {
    this.initialize(img._10);
  }).prototype = p = new cjs.Bitmap();
  p.nominalBounds = new cjs.Rectangle(0, 0, 286, 71);
  ...
  p.nominalBounds = new cjs.Rectangle(0, 0, 275, 71);
  ...
  (lib.Symbol4 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AADC1IgDAAIgCAAIk4AAQh9AAAAh9IAAhvQAAh9B9AAIE4AAIACAAIADAAIE4AAQB9AAAAB9IAABvQAAB9h9AAg",
      );
  ...
  (lib.Symbol2 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "Eg//ADZIAAmxMBEpAAAQBkAAAABkIAADpQAABkhkAAgEA89ACdQAyhGgBhZQAAhgg2hJIDHAAIAAFIgEAzvACdQAxhGABhZQgBhgg3hJICEAAQg4BJABBgQgBBZAyBGgEAqzACdQhkAAAAhkIAAiAQAAhkBkAAIBsAAQg4BJAABgQABBZAxBGg",
      );
  ...
  (lib.mc_01 = function (mode, startPosition, loop) {
    ...
    this.shape_15.graphics
      ...
      .ss(0.5, 1, 1)
      .p(
        "AAVAAIAcAFIgBAEIgFAeAAVAAIgNgBIgXgFIgbgFIgCANAAQgiIALACIgGAgAAQgiIgGgBQgMgCgJAMIgDAKQAWgBAIgSgAgvAPIADgNQALgEASAAQALgBAMACAgPgGIABgJAgLgZIACgNIATADAAtAIQguASgugLAgwAWIABgH",
      );
    ...
    this.shape_17.graphics
      ...
      .ss(0.5, 1, 1)
      .p(
        "ABhgZIABADQAGAAAGAAIAAAAABugWQABAAABAAAD+BOIABgBQAAAAgBAAADYBHIAAAAAj/hFIABgIAjZgYIAAAA",
      );
  ...
  (lib.Cherecter3 = function (mode, startPosition, loop) {
    ...
    this.instance.setTransform(-136.5, -36);

    this.instance_1 = new lib._2();
    this.instance_1.setTransform(-136.5, -36);

    this.timeline.addTween(
      cjs.Tween.get({})
        .to({ state: [{ t: this.instance }] })
        .to({ state: [{ t: this.instance_1 }] }, 27)
        .wait(32),
    );
  }).prototype = p = new cjs.MovieClip();
  p.nominalBounds = new cjs.Rectangle(-136.5, -36, 273, 72);
  ...
  (lib.Cherecter2 = function (mode, startPosition, loop) {
    ...
    this.instance.setTransform(-143, -35.5);

    this.instance_1 = new lib._8();
    this.instance_1.setTransform(-143, -35.5);

    this.instance_2 = new lib._9();
    this.instance_2.setTransform(-143, -35.5);

    this.instance_3 = new lib._10();
    this.instance_3.setTransform(-143, -35.5);

    this.timeline.addTween(
      cjs.Tween.get({})
        .to({ state: [{ t: this.instance }] })
        .to({ state: [{ t: this.instance_1 }] }, 7)
        .to({ state: [{ t: this.instance_2 }] }, 7)
        .to({ state: [{ t: this.instance_3 }] }, 7)
        .wait(7),
    );
  }).prototype = p = new cjs.MovieClip();
  p.nominalBounds = new cjs.Rectangle(-143, -35.5, 286, 71);
  ...
  (lib.Cherecter1 = function (mode, startPosition, loop) {
    ...
    this.instance.setTransform(-137.5, -35.5);

    this.instance_1 = new lib._4();
    this.instance_1.setTransform(-137.5, -35.5);

    this.instance_2 = new lib._5();
    this.instance_2.setTransform(-137.5, -35.5);

    this.instance_3 = new lib._6();
    this.instance_3.setTransform(-137.5, -35.5);

    this.timeline.addTween(
      cjs.Tween.get({})
        .to({ state: [{ t: this.instance }] })
        .to({ state: [{ t: this.instance_1 }] }, 7)
        .to({ state: [{ t: this.instance_2 }] }, 8)
        .to({ state: [{ t: this.instance_3 }] }, 8)
        .wait(8),
    );
  }).prototype = p = new cjs.MovieClip();
  p.nominalBounds = new cjs.Rectangle(-137.5, -35.5, 275, 71);
  ...
  (lib.tree_Iceland = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      .f("#845744")
      .s()
      .p("AGCCNQmAhnnSgmIC9iCQAKgLAOgIQA0gcBuAgIGbCJQAfAIAtA8QAfAoAkA/IhPgWg");
    ...
    this.shape_1.graphics
      .f("#DBBA91")
      .s()
      .p("AGZBZIs5hgQhsAGAggtIA/grQHSAnGABmIBPAWQgDAQg3AAIghgBg");
    ...
    this.shape_3.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_4.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_5.graphics
      ...
      .s()
      .p(
        "AgRDNQhDgDgUgVQgiABACgfQg0gfAjggQghg4A7gGQAGgtAoAhQAqgWAHAhQAfgYASAdIATgEQgTgPAGgeQgugXAbgvQgkgKAbggQgjgiArgOQgchIBOAeQAQgfAaAmQgxAIALAnQgUARAJAmQgHAmAgAGQAIAnAhAAQgHAuA7gCIAEATQgngIgKAbQg8gIgLArQhAABATA7QgWAeAjA6QgTgMgOgTg",
      );
    ...
    this.shape_6.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_8.graphics
      ...
      .s()
      .p(
        "AwEGBIFQrTQAKgrATgiQBOh7DzA0IOmD5QBDANCRC5QBhB4CBDFQAKBJivAbI6rBmQg/AXgqAAQhfAAAOh2g",
      );
  ...
  (lib.Symbol3 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      .f("#0F204B")
      .s()
      .p("A1hGJIAAsRMApGAAAQB+AAgBB9IAAIXQABB9h+AAg");
    ...
    this.shape_1.graphics
      .f("#0F204B")
      .s()
      .p("AsjGJIjLAAIgmAAQh9AAAAh9IAAoXQAAh9B9AAIAmAAIDLAAIe1AAIAAMRg");
  ...
  (lib.Button_Set_1 = function (mode, startPosition, loop) {
    ...
    // Layer 3
    this.shape = new cjs.Shape();
    this.shape.graphics.f("#FFFFFF").s().p("AgOEPIAAodIAdAAIAAIdg");
    this.shape.setTransform(-249.6, 0.9);
  ...
  (lib.Bg = function (mode, startPosition, loop) {
    ...
    this.shape = new cjs.Shape();
    this.shape.graphics
      .f("rgba(172,243,235,0.576)")
      .s()
      .p(
        "AlIDLQjJgkhWg3QkBijEehMQBYgohMgiQgBgBAAAAQAAAAAAAAQgBgBAAAAQAAAAgBAAQhZgnksghQDCgEDNAyIAEACQBFARBGAXQAVAMAEAMQAEAVg1AUQgsAQhTAPQicA9BoBEQA1AoBMAfQBOAeBlAUIBGALICMAIIFMAUQOFA3i+AXQteAAmQhJg",
      );
    this.shape.setTransform(394, 550.2);

    this.shape_1 = new cjs.Shape();
    this.shape_1.graphics
      .f("rgba(172,243,235,0.588)")
      .s()
      .p(
        "AgZAmQl+AAkQgOQkQgNgHgcQgHgeEXAOQEXANF+AAQF8AAEbAJIAmABQD3AJAhAJQAjAMk+AJIgiACQkwAHlnAAIgBAAg",
      );
    ...
    this.shape_6.graphics
      ...
      .s()
      .p(
        "Ah6AbIgDgCQAAgBAAAAQAAgBAAAAQAAgBAAAAQABgBAAAAQAlguDVgBQgoAGgwANQiZAggCACIgFAAg",
      );
    ...
    this.shape_7.graphics
      ...
      .s()
      .p(
        "AjqAHQAxABASgBQBagEAhgPIAFgBIADACICwgCQCwgEiZAPQiYAKiyAGIAAAAIgHABQgXAAglgIg",
      );
    ...
    this.shape_8.graphics
      ...
      .s()
      .p(
        "Ai5ANQkWgHCVgFQCWgCAAgBIABgDQAAAAAAAAQABgBAAAAQAAAAABAAQABgBAAAAQAAAAABAAQAAgBAAAAQABAAAAAAQAAAAABABQAuAHBrAGQBeAHAkAAQAqAAArgOQAsgSBrAAQABAAAAAAQABAAABAAQAAAAABABQAAAAABABIAAABIAAADIgFABQhnAAgrAPQguARgsAAQgkAAkTgHg",
      );
    ...
    this.shape_9.graphics
      ...
      .s()
      .p(
        "AiKAKQiQgKDlAAQDigCgDgCQAAgBgBAAQAAAAAAgBQgBAAAAAAQAAgBAAAAQAAgBAAAAQAAAAABAAQAAgBAAAAQABAAAAAAQAAgBABAAQAAAAAAgBQABAAAAAAQABAAAAAAQABAAAAAAQABAAABAAQAAABABAAQAAAAABABIAKAGIAHACQiKANhtAAQgtAAgpgCg",
      );
    this.shape_9.setTransform(55.2, 481.4);

    this.shape_10 = new cjs.Shape();
    this.shape_10.graphics
      .f("rgba(255,255,255,0.576)")
      .s()
      .p(
        "AkMAiQgngFg3gWQk5gkE+AdQE8AeCCggQCIgiBeAAQAsAAAoALQAvANBCAfQABABAAAAQABAAAAAAQAAABAAAAQAAAAAAABIgBADIgDABIgEAAQhAgfgWAKQgXAMhJgJQhLgIiTATQiRAShXAAQh4ABgWgEg",
      );
    this.shape_10.setTransform(67.6, 722.4);

    this.shape_11 = new cjs.Shape();
    this.shape_11.graphics
      .f("rgba(51,255,255,0.22)")
      .s()
      .p(
        "AlAAfQksgdDRgBIC1gBIgEAAIgBgCIABgCQABgBAAAAQABgBAAAAQABAAAAAAQABAAAAAAQAbAABkAGQBiAEARAAQC/AACBgUQCOgYATAAIAEABIABACIgBADIgMAFQgLAEj5ApQiXAZioAAQhtAAh1gKg",
      );
    ...
    this.shape_12.graphics
      ...
      .s()
      .p(
        "AmTAMQjHgPgiAAIgDgBQgBAAAAgBQgBAAAAgBQAAAAAAgBQAAAAAAAAQAAgBAAAAQAAAAAAAAQAAgBABAAQAAAAABAAQAAgBABAAQAAAAAAgBQABAAAAAAQABAAAAAAIDnAFIArACQDlAEC9gUIASgCQBVgKBcAJQKGAjmjgLQmkgJAAABIgBADQgzAhi7AAQgXAAjHgRg",
      );
    ...
    this.shape_13.graphics
      .f("#9EE6F2")
      .s()
      .p("AjRgBQgMgiCrAGIBQACIB0ADQAaAAAmAgIgygUQgpAAhcAUQhbAXgjAAQg4AAg2ggg");
    ...
    this.shape_14.graphics
      ...
      .s()
      .p(
        "ADsAAQgigKhWAAQgVAAh8AKQiAALgTAAQghAAgtgJQgigGgdgJQBCgJCmgLQClgLALgBQCAABAdAEQBGAKAABLQg4glgagIg",
      );
    this.shape_14.setTransform(896.3, 450.2);

    this.shape_15 = new cjs.Shape();
    this.shape_15.graphics
      .f("rgba(158,230,242,0.847)")
      .s()
      .p(
        "AgLAUIgEgBQihgKjMgDQjPgDhOgKIgDgCQAAAAgBgBQAAAAAAAAQAAgBgBAAQAAAAAAgBIAEgCQAAAAAAAAQABgBAAAAQABAAAAAAQABAAAAABQBOAMDNACQDMACCogQQCngTDYAQQDYAQAmgHQAlgGACAAIADABIAAAEIgDACQhNAXjfAHQhdAChSAAQhyAAhagFg",
      );
    this.shape_15.setTransform(797.3, 694.9);

    this.shape_16 = new cjs.Shape();
    this.shape_16.graphics
      .f("rgba(255,255,255,0.267)")
      .s()
      .p(
        "AiiASQkigHgqgLQgogLgCgCIgBgDQAAAAABAAQAAgBAAAAQAAAAABAAQAAgBABAAIACgBQBsAPE2AAQE0gBFUgOQAAAAABAAQAAAAAAABQABAAAAAAQAAAAABABIABABIgBAEQgBABjNARQiZAOjIAAIiMgCg",
      );
    this.shape_16.setTransform(1023.9, 574.1);

    this.shape_17 = new cjs.Shape();
    this.shape_17.graphics
      .lf(["#28CEF5", "#94FBFD"], [0, 1], 970.1, -29.7, 969.9, 26.8)
      .s()
      .p(
        "AoTBKQjYgdADgtQADgrDaggQDageE2AAQE0AADWAeQDdAggDArQgCAtjhAdQjaAgkxAAQk4AAjWggg",
      );
    ...
    this.shape_18.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_20.graphics
      ...
      .s()
      .p(
        "AouEGQAAgFABgEQAIgcBAgjQAbg+j6gVQvIgphZhYQgKgJAAgKQgBgJAJgKIACgCQAkgmCtgvQMri1LkgUIBrgBICFABQBCgBBCACIAJABQFRAWE9AqQE9ArEDCZQAfAIAZAIIAFACQA4ATAbAWQBhBOkEBiIg0AMQq7CetiAfQoLgIgFhQg",
      );
    this.shape_20.setTransform(528.1, 494.7);

    this.shape_21 = new cjs.Shape();
    this.shape_21.graphics
      .lf(["#16B6DB", "#49D9FA"], [0, 1], -1165, -225.1, -1165, -110.4)
      .s()
      .p(
        "",
      );
    this.shape_21.setTransform(548.1, 642.5);

    this.shape_22 = new cjs.Shape();
    this.shape_22.graphics
      .lf(["#28CEF5", "#94FBFD"], [0, 1], 939.8, -67.9, 939.2, 71.5)
      .s()
      .p(
        "",
      );
    this.shape_22.setTransform(524.9, 513.8);

    this.shape_23 = new cjs.Shape();
    this.shape_23.graphics
      .lf(["#28CEF5", "#94FBFD"], [0, 1], -232.5, -94.8, -233.9, 211.7)
      .s()
      .p(
        "EhVogf2MCrQAAAMAAAA/jMiCOgABMgpCAALgAcHaoIgBABIgBAGIgBAJQAAAFAEgTIAAgBIgBgCIAAABgALuavIABAFIADgCIACgDgAdPSqIACABIAAgFIgCAEgAdpRyIAAABIAEADIAAgIIgEAEgAISRFIABADIABgGQAAAAAAABQAAAAAAABQgBAAAAAAQgBABAAAAgA+yQVIABgCIgBgDIAAAFgAGZPkIAEAAIgEgRQgBAJABAIg",
      );
  ...
  (lib.mc_Helicopter1_1 = function (mode, startPosition, loop) {
    ...
    this.shape_12.graphics
      ...
      .ss(0.5, 1, 1)
      .p(
        "AofhQIgBgIAnygrIAAAAAi7hkIABADQAGgCAGgBQABAAAAAAAiuhkIAAAAAgOgZIABAAQgBAAAAAAAg1gZIAAAAAHRhWQAdAAAUAUQAVAVAAAdQAAAbgVAUQgUAVgdAAQgdAAgVgVQgUgUAAgbQAAgdAUgVQATgSAYgCQAEAAADAAgAIWBfIgFACAIhBcQgFgBgFgCAGiBmIAAAA",
      );
    ...
    this.shape_22.graphics
      ...
      .ss(0.5, 1, 1)
      .p(
        "AguAaIAAgNQALgIARgDQALgCAMAAIgXAAIgcAAIAAANAguAhIAAgHAgSgTIAAgOIATAAQgMABgHANIAAAKQAVgFAEgTIALAAIAAAhIAdAAIAAADIAAAeAAHghIgGAAAgSAAIAAgJAASAAIgNAAAArADQgrAagugD",
      );
  ...
  (lib.Netforceandacceleration = function (mode, startPosition, loop) {
    ...
    this.instance_1.setTransform(492, 453.8);

    this.instance_2 = new lib.Cherecter2();
    this.instance_2.setTransform(496.7, 454.2);

    this.instance_3 = new lib.Cherecter3();
    this.instance_3.setTransform(490.4, 454.6);
