(function (lib, img, cjs, ss) {
  ...
  lib.properties = {
    ...
    fps: 24,
    color: "#CCCCCC",
    manifest: [{ src: "images/Cutpng.jpg?1493877784724", id: "Cutpng" }],
  };
  ...
  (lib.RoadTrack = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "A9sdsQsUsSAAxaQAAxZMUsTQMTsURZgBQRaABMUMUQMTMTAARZQAARasTMSQsUMWxaAAQxZAAsTsWgA6161QrHLGAAPvQAAPrLHLHQLHLJPuAAQPsAALIrJQLHrHAAvrQAAvvrHrGQrIrIvsAAQvuAArHLIg",
      );
    ...
    this.shape_1.graphics
      ...
      .s()
      .p(
        "",
      );
  ...
  (lib.Bg = function (mode, startPosition, loop) {
    ...
    this.shape_6.graphics
      .f("#959595")
      .s()
      .p("AC3AJIluAAIgDAAIAAAAIACAAIAAgRIFzAAIAAARg");
    ...
    this.shape_20.graphics
      .f("#0F2C0C")
      .s()
      .p("AmrAKIAAgTIASAAIAAAAIMtAAIARAAIAGAKIAAAJg");
    ...
    this.shape_21.graphics
      .f("#79807D")
      .s()
      .p("AmWAOIAAgGIAAgBIAAgTIASAAIMIAAIATAAIAAABIAAAZg");
    ...
    this.shape_24.graphics
      .f("#8DAC8A")
      .s()
      .p("AmsANIgBAAIAAgZIA2AAIIAAAIElAAIAAAYIgXAAIAAgBIsuAAIAAACg");
