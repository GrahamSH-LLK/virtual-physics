var Lab = (function () {
  ...
  Activity.prototype.startLab = function () {
    ...
    this.player1.addEventListener("enableGo", this._enableGo);
    this.player2.addEventListener("enableGo", this._enableGo);
  ...
  function checkWinner(e) {
    ...
    helLinePoint = Model.getPoint(
      Model.pointOnBoundry,
      -90 * Maths.TO_RADIANS,
      250,
    );
    subLinePoint = Model.getPoint(
      Model.pointOnBoundry,
      0 * Maths.TO_RADIANS,
      250,
    );
  ...
  Class.prototype = {
    ...
    nextAngle: function () {
      ...
      if (Model.count == 5) {
        ...
        this.angle = this.cAngle = Model.submarine.Angles[0] + variance * 5;
      }
      Model.count++;
    },
    ...
    drawArc: function () {
      ...
      var displayHelAngle, displaySubAngle;
      (displayHelAngle =
