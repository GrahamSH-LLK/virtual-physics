...
var obstacleArray = [{ left: 665, right: 685, top: 295, bottom: 667 }];
var sandTrap = [{ left: 700, right: 796, top: 434, bottom: 603 }];
var scores = {
  score1: 0,
  score2: 0,
  score3: 0,
...
var Lab = (function () {
  ...
  function updateTable() {
    this.layout.score2.text = this.putCount;
    ...
    if (this.temp < 0) {
      this.layout.diff2.color = "green";
      this.layout.diff2.text = this.temp;
    } else {
      this.layout.diff2.color = "red";
      this.layout.diff2.text = "+" + this.temp;
    }
    ...
    scores["score2"] = this.putCount;
    diff["diff2"] = this.temp;
  }
  ...
  Activity.prototype.reset = function () {
    ...
    this.layout.distance.text = "0.238";
    this._allCharges.putter.reset();
    // this._allCharges.putter._pressmove();
    ...
    lab.layout.YouDidIt.visible = false;
    ...
    this.layout.score2.text = 0;
    this.layout.diff2.color = "black";
    this.layout.diff2.text = "--";
    this.putCount = 0;
    this._onBallStop();
  };
  ...
  Activity.prototype._createInstances = function () {
    var array = ["ball", "putter", "chargep30e", "chargep-10e"],
      object,
      scope = this;
...
var ChargeClass = (function () {
  ...
  Class.prototype._Hole = function (_charges) {
    ...
    lab.layout.ball.x = 890;
    lab.layout.ball.y = 486;
  ...
  Class.prototype._update = function (_charges, count) {
    if (this.started) {
      ...
      if (
        lab.layout.ball.x < 904 &&
        lab.layout.ball.x > 878 &&
        lab.layout.ball.y < 498 &&
        lab.layout.ball.y > 475 &&
  ...
  Class.prototype._moveObject = function (_charges) {
    ...
    if (this.type == TYPE_BALL) {
      ...
      if (
        _charges[0].charge < 0 &&
        Maths.getDistance(_charges[0], this) / this._unit <
          0.1 /* (_charges[0].xRadius / this._unit) < (.1) */
      ) {
        this._velocity.set(0, 0);
        this.x =
          _charges[0].x +
      ...
      // skipped
      if (this.x > 705 && this.x < 795 && this.y > 435 && this.y < 598) {
  ...
  Class.prototype._findAccelVecs = function (_charges) {
    ...
    if (this._intersects(sandTrap[0])) {
  ...
  Class.prototype._click = function () {
    ...
    window.location.href =
      "../Hole 3_How the charge values affect the force/index.html?" +
      a +
      "&" +
      b;
  };
