...
var obstacleArray = [];
var sandTrap = [
  { left: 740, right: 790, top: 585, bottom: 641 },
  { left: 63, right: 119, top: 301, bottom: 360 },
];
var scores = {
  score1: 0,
  score2: 0,
...
var Lab = (function () {
  ...
  function updateTable() {
    this.layout.score5.text = this.putCount;
    ...
    if (this.temp < 0) {
      this.layout.diff5.color = "green";
      this.layout.diff5.text = this.temp;
    } else {
      this.layout.diff5.color = "red";
      this.layout.diff5.text = "+" + this.temp;
    }
    ...
    scores["score5"] = this.putCount;
    diff["diff5"] = this.temp;
  }
  ...
  Activity.prototype.reset = function () {
    ...
    this.layout.distance.text = "0.170";
    ...
    this.layout.score5.text = 0;
    this.layout.diff5.color = "black";
    this.layout.diff5.text = "--";
    this.putCount = 0;
    this._onBallStop();
  };
...
var ChargeClass = (function () {
  ...
  Class.prototype._update = function (_charges, count) {
    if (this.started) {
      ...
      if (
        lab.layout.ball.x < 947 &&
        lab.layout.ball.x > 922 &&
        lab.layout.ball.y < 383 &&
        lab.layout.ball.y > 359 &&
  ...
  Class.prototype._moveObject = function (_charges) {
    ...
    if (this.type == TYPE_BALL) {
      ...
      // skipped
      if (this.x > 740 && this.x < 790 && this.y > 585 && this.y < 641) {
        Vector.multiply(Ff, 5, Ff);
      } else if (this.x > 63 && this.x < 119 && this.y > 301 && this.y < 360) {
        Vector.multiply(Ff, 5, Ff);
      }
