...
var obstacleArray = [];
var sandTrap = [{ left: 800, right: 970, top: 76, bottom: 254 }];
var scores = {
  score1: 0,
  score2: 0,
  score3: 0,
...
var Lab = (function () {
  ...
  function updateTable() {
    this.layout.score4.text = this.putCount;
    ...
    if (this.temp < 0) {
      this.layout.diff4.color = "green";
      this.layout.diff4.text = this.temp;
    } else {
      this.layout.diff4.color = "red";
      this.layout.diff4.text = "+" + this.temp;
    }
    ...
    scores["score4"] = this.putCount;
    diff["diff4"] = this.temp;
  }
  ...
  Activity.prototype.reset = function () {
    ...
    this.layout.distance.text = "0.229";
    ...
    this.layout.score4.text = 0;
    this.layout.diff4.color = "black";
    this.layout.diff4.text = "--";
    this.putCount = 0;
    this._onBallStop();
  };
  ...
  Activity.prototype._createInstances = function () {
    var array = ["ball", "putter", "chargep60e", "chargep-36e"],
      object,
      scope = this;
...
var ChargeClass = (function () {
  ...
  Class.prototype._update = function (_charges, count) {
    if (this.started) {
      ...
      if (
        lab.layout.ball.x < 914 &&
        lab.layout.ball.x > 892 &&
        lab.layout.ball.y < 603 &&
        lab.layout.ball.y > 578 &&
  ...
  Class.prototype._moveObject = function (_charges) {
    ...
    if (this.type == TYPE_BALL) {
      ...
      // skipped
      if (this.x > 801 && this.x < 965 && this.y > 78 && this.y < 246) {
  ...
  Class.prototype._click = function () {
    ...
    window.location.href =
      "../Hole 5_Electric golf − the practice green/index.html?" + a + "&" + b;
  };
