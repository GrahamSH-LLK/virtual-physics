var Lab = (function () {
  ...
  function pressUp(e) {
    ...
    //console.log(secPlay);
    if (counter1 + counter2 == 2 && secPlay == false) {
  ...
  function calculateForces() {
    ...
    if (absForce == 0) {
      ...
      //console.log(forceConvert.number.toFixed(2));
