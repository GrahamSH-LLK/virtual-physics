...
if (window.location.protocol == "file:" || true) {
  Object.defineProperty(createjs.DisplayObject.prototype, "worldX", {
    get: function () {
      if (this.parent) {
        return (
          (this.x - this.regX * this.scaleX) * this.parent.scaleX +
          this.parent.worldX
        );
      } else {
  ...
  Object.defineProperty(createjs.DisplayObject.prototype, "worldY", {
    get: function () {
      if (this.parent) {
        return (
          (this.y - this.regY * this.scaleY) * this.parent.scaleY +
          this.parent.worldY
        );
      } else {
  ...
  createjs.Container.prototype._getObjectsUnderPoint = function (
    x,
    y,
    arr,
    mouse,
    ...
    for (var i = l - 1; i >= 0; i--) {
      ...
      if (!hitBounds && child instanceof createjs.Container) {
        ...
        try {
          ...
          /////////////////////////////////////////////
          if (!child.debugShape && window.debugHit) {
          ...
          if (window.debugHit) {
            // console.log(_bounds)
            child.debugShape.graphics
              .clear()
              .beginFill("rgba(255,255,0,0.5)")
              .rect(_bounds.x, _bounds.y, _bounds.width, _bounds.height)
              .endFill();
          }
          /////////////////////////////////////////////
...
function resizeStage() {
  ...
  backgroundStage.scaleX =
    backgroundStage.scaleY =
    foregroundStage.scaleX =
    foregroundStage.scaleY =
      scale;
}
