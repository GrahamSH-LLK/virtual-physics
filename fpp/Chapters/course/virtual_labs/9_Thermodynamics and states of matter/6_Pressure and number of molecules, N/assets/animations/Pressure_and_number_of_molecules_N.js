(function (lib, img, cjs, ss) {
  ...
  (lib.Symbol2copy3 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "Eg//ADZIACmxMBl0AAAQBkAAAABkIAADpQAABkhkAAgEA8+ACdQAxhFAAhaQAAhfg3hKIDIAAIAAFIgEAzwACdQAxhFAAhaQAAhfg3hKICEAAQg4BJAABgQAABaAyBFgEAq0ACdQhkAAAAhkIAAiAQAAhkBkAAIBsAAQg4BJAABgQAABaAyBFg",
      );
  ...
  (lib.Symbol3 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "EAosgGQIT+ADQBdAPAABrIAAInQAABthdAOIz+ACgAHwGRIAAshIADAAMAgkAAAIAEAAIAAMhgEgrTAGRIAAshMAywAAAIAAMhgEg8JAGRQh9AAAAh9IAAonQAAh9B9AAIQkAAIAAMhg",
      );
  ...
  (lib.mc_patch = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      .f("#FFFFFF")
      .s()
      .p("EAp4AEPIAAodIARAAIAAIdgAI6EPIAAodIATAAIAAIdgEgqIAEPIAAodIASAAIAAIdg");
  ...
  (lib.bg = function (mode, startPosition, loop) {
    ...
    this.shape_5.graphics
      .f("#FFFFFF")
      .s()
      .p("EBHMAAVIAAgpIDHAAIAAApgEhKSAAUIAAgoICpAAIAAAog");
    ...
    this.shape_6.graphics
      ...
      .s()
      .p(
        "EhKTABIMCUmAAAIAAAlMiUmAACgEhKTAArIAAgYICqAAIAAgoIiqAAIAAgoMCUmAAAIAAAoIjHAAIAAApIDHAAIAAAXgEhKTgBaIAAgRMCUUgADIASAAIAAADIAAACIAAAPg",
      );
