      ...
      this._defaultPositions.push({
        x:
          ...
          getRandomNum(
            ...
            Model.boundary.width - this._moleculeRadius,
          ),
        y:
          Model.boundary.y +
          getRandomNum(
            this._moleculeRadius,
            Model.boundary.height - this._moleculeRadius,
          ),
      });
      m.reset(
        this._defaultPositions[this.molecules.length - 1],
        Model.pointToPixel(this._defaultVelocity),
      );
      mc.cache(
        -this._moleculeRadius,
        -this._moleculeRadius,
        this._moleculeRadius * 2 + 1,
        this._moleculeRadius * 2 + 1,
      );
