(function (lib, img, cjs, ss) {
  ...
  (lib.Symbol2copy = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "EhQEAEPIAAodMBITAAAQB9gBAAB+IAAEjQAAB+h9gBgEBMSADFQA+hYAAhwQAAh3hFhcID6AAIAAGbgEBAwADFQA+hYAAhwQAAh3hEhcICkAAQhFBbAAB4QAABwA9BYgEA1lADFQh9gBAAh9IAAigQAAh9B9AAICHAAQhFBbAAB4QAABwA+BYg",
      );

    this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));
  }).prototype = p = new cjs.MovieClip();
  p.nominalBounds = new cjs.Rectangle(-512.5, -27.2, 1025.2, 54.4);
  ...
  (lib.Symbol1 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AADIpIAAxRIZjAAQBkAAAABtIAAN3QAABthkAAgA5lIpQhkAAAAhtIAAt3QAAhtBkAAIZQAAIAARRg",
      );
    this.shape.setTransform(-30.2, 0);

    this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));
  }).prototype = p = new cjs.MovieClip();
  p.nominalBounds = new cjs.Rectangle(-204, -55.3, 347.7, 110.7);
  ...
  (lib.ClipGroup_0_1 = function (mode, startPosition, loop) {
    ...
    this.shape_1.graphics
      .f("#FFFFFF")
      .s()
      .p("AAHAgQAmgjAShLIAMgGQgDAjgUAnQgpBNhVASQBCgkAPgRg");
    this.shape_1.setTransform(7.5, 8.6);
  ...
  (lib.Symbol9 = function (mode, startPosition, loop) {
    ...
    this.instance.setTransform(-239.9, 0, 1.25, 1.25);
  ...
  p.nominalBounds = new cjs.Rectangle(-512.5, -69.2, 1025.2, 138.4);
  ...
  (lib.Symbol3copy4 = function (mode, startPosition, loop) {
    ...
    this.shape.setTransform(-278.8, 1.4);
  ...
  p.nominalBounds = new cjs.Rectangle(-538.5, -94.7, 1080, 193);

  (lib.mc_redBall = function (mode, startPosition, loop) {
    this.initialize(mode, startPosition, loop, {});
  ...
  // stage content:
  (lib.Simulatinganidealgas = function (mode, startPosition, loop) {
    this.initialize(mode, startPosition, loop, {});
    ...
    this.instance_1.setTransform(511.6, 722.6);

    this.instance_2 = new lib.mc_redBall("synched", 0);
    this.instance_2.setTransform(432, 407, 1, 1, 0, 0, 0, 21.6, 21.6);

    this.instance_3 = new lib.mc_blueBall("synched", 0);
    this.instance_3.setTransform(586.8, 407, 1, 1, 0, 0, 0, 21.6, 21.6);
