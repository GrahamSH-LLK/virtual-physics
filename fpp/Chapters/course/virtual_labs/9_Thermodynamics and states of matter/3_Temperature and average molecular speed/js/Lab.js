var Lab = (function () {
  function Activity() {
    ...
    this._moleculeRadius = 21.6;
    this._moleculeMass = 0.1;
  ...
  function meanVel() {
    ...
    this.layout.speedText.text = Number(this._m_gAvgPartSpd.toFixed(0));
  }
