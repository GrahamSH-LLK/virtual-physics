(function (lib, img, cjs, ss) {
  ...
  (lib.Symbol4copy3 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AiQCTIgNAAQggAAgXgQQgZgQAAgwIAAiFQAAgsAZgUQAUgQAjAAIANAAIEuAAQBQAAAABQIAACFQAABQhQAAg",
      );
    this.shape.setTransform(104.9, 5.4);

    this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));
  }).prototype = p = new cjs.MovieClip();
  p.nominalBounds = new cjs.Rectangle(81, -9.4, 47.8, 29.5);
  ...
  (lib.Symbol2copy3 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "EhADADZIAAmxMBJAAAAQBkAAAABkIAADpQAABkhkAAgEA9BACdQAyhFAAhaQAAhfg3hKIDIAAIAAFIgEAz0ACdQAxhFAAhaQAAhfg3hKICEAAQg4BJAABgQAABaAyBFgEAq3ACdQhjAAAAhkIAAiAQAAhkBjAAIBsAAQg3BJAABgQAABaAxBFg",
      );
    this.shape.setTransform(512.7, 21.8);

    this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));
  }).prototype = p = new cjs.MovieClip();
  p.nominalBounds = new cjs.Rectangle(102.6, 0, 820.1, 43.5);

  (lib.mc_blueBall = function (mode, startPosition, loop) {
    this.initialize(mode, startPosition, loop, {});

    // Layer 1
    this.instance = new lib.ClipGroup_0();
    this.instance.setTransform(34.5, 33.8, 1, 1, 0, 0, 0, 8, 9);

    this.instance_1 = new lib.ClipGroup_1();
    this.instance_1.setTransform(21.6, 21.6, 1, 1, 0, 0, 0, 21.6, 21.6);
  ...
  (lib.Symbol3copy4 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AFHFLIjhAAIAAhcIAAhsIAAljIAAhqICdAAIBEAAIcQAAQBkABAABjIAAHNQAABjhkABgAhXFLIggAAI/fAAQhkgBAAhjIAAnNQAAhjBkgBIffAAIAIAAIAYAAICqAAIAABqIAAFjIAABsIAABcg",
      );
    this.shape.setTransform(340.2, 31.5);
  ...
  p.nominalBounds = new cjs.Rectangle(102.6, -1.6, 820.1, 66.2);
  ...
  (lib.mc_patch = function (mode, startPosition, loop) {
    ...
    this.instance.setTransform(-128.2, -6.6, 1.25, 1.25);
    ...
    this.shape.graphics
      .f("#FFFFFF")
      .s()
      .p("AgKEPIAAgCIAAhyIAAmoIAAgBIAWAAIAAABIAAGoIAAByIAAACg");
    this.shape.setTransform(-204.1, 0.9);

    this.instance_1 = new lib.Symbol3copy4();
    this.instance_1.setTransform(0, 0.1, 1.25, 1.25, 0, 0, 0, 512.6, 31.5);
  ...
  p.nominalBounds = new cjs.Rectangle(-538.5, -67.3, 1080, 138);

  // stage content:
  (lib.Temperatureandaveragemolecularspeed = function (
    mode,
    startPosition,
    loop,
  ) {
    ...
    // Layer 2
    this.instance = new lib.mc_blueBall("synched", 0);
    this.instance.setTransform(586.8, 407, 1, 1, 0, 0, 0, 21.6, 21.6);

    this.instance_1 = new lib.mc_bg("synched", 0);
    this.instance_1.setTransform(512.1, 265.5, 1, 1, 0, 0, 0, 512.3, 266.3);

    this.instance_2 = new lib.mc_patch();
    this.instance_2.setTransform(511.6, 743.8);
