(function (lib, img, cjs, ss) {
  ...
  lib.properties = {
    ...
    fps: 24,
    color: "#CCCCCC",
    manifest: [{ src: "images/Path.png", id: "Path" }],
  };
  ...
  (lib.wood = function () {
    ...
    this.shape_6.graphics
      .f("#D00000")
      .s()
      .p("Eg+nAFHQjlgGgfiSQgfiSAFgpQAFgsAYiEQAXiGCrgEMCB5AALQBnG7hnDHg");
  ...
  (lib.window1 = function () {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AhFCWIAAjGIADgKIABgGIAAgBQANglAhgfIAHgGIAEgEIABgBIAHgFIAAAAIAIAGIAFAEIAHAGIAAAAQAkAiAMApIACAKIAADGgAAAh3IgGAEIgEADQgcAYgLAdIgCAEIgDAJIgBAFIAAADIAACmIBwAAIAAimIgEgMIgDgIQgLgdgcgZIgFgDIgGgFIAAAAIAAgBg",
      );
    ...
    this.shape_1.graphics
      ...
      .s()
      .p(
        "Ag4B9IAAimIABgDIABgFIADgJIACgEQALgdAcgYIAEgDIAGgEIAAgCIAAABIAAAAIAGAFIAEADQAdAZALAdIADAIIAEAMIAACmg",
      );
  ...
  (lib.top1 = function () {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AixEZIhwiYIAAgBIAAmYIAXAAIAOAoIgBAAIAACVIABgBIAkAAIACAAIABAAIAVAAIAAAAIAAiUIAVgoIBXAAIAPAoIAACUIA8AAIAAAAIAAiUIATgoIALAAIA/AAIABAAIAPAoIAACUIAsAAIATAAIAAAAIAAiUIAOgoIBVAAIATAlIAACXIAJAAIAADcIAAABIhwCYg",
      );
    ...
    this.shape_1.graphics
      ...
      .s()
      .p(
        "AC6BMIBwiWIABgBIEbAAIAAABIAAABIAAAAIgvAdIgDADIiMBbIgBAAIgiAWIgMAEgAlbBMIgjgWIgEgCIgbgSIgCAAIAAgCIimhrIEsAAIAAABIBxCWg",
      );
    this.shape_1.setTransform(73.8, 45);

    this.shape_2 = new cjs.Shape();
    this.shape_2.graphics
      .f("rgba(12,12,12,0.298)")
      .s()
      .p(
        "AErDMIgBAAIAAjbIAKAAIAYAAIAAgBIAAiTIAOgoIBUAAIATAlIAACXIAIAAIAKAAIAIAAIAAiUIAOgoIASAAIABAAIAaAAIAcAAIAUAoIAAFvgAkZDMIksAAIAAlsIABgDIAVgoIAaAAIA5AAIASAAIAOAoIgBAAIAACUIABAAIAMAAIA2AAIAAiUIABgCIAUgmIBMAAIAAGXg",
      );
    ...
    this.shape_3.graphics
      .f("#0C0C0C")
      .s()
      .p("AJFABIABgBIAAABgApFAAIAAAAIABAAgAkZAAIAAAAIAAAAgAEqAAIABAAIgBAAg");
    ...
    mask._off = true;
    mask.graphics.p(
      "",
    );
    ...
    this.shape_4.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_5.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_6.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_7.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_9.graphics
      .f("#D88F6F")
      .s()
      .p("AJFABIABgBIAAABgApFAAIAAAAIABAAg");
  ...
  (lib.Symbol255 = function () {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "ATxDZIAAmxIMRAAQBkAAAABkIAADpQAABkhkAAgEg/+ADZIAAmxMBPDAAAIAAGxgEA89ACdQAxhGAAhZQAAhgg3hJIDIAAIAAFIgEAzvACdQAxhGAAhZQAAhgg3hJICEAAQg4BJAABgQAABZAyBGgEAqzACdQhkAAAAhkIAAiAQAAhkBkAAIBsAAQg4BJAABgQAABZAyBGg",
      );
  ...
  (lib.Symbol4 = function () {
    ...
    this.shape.graphics
      .f("#FFFFFF")
      .s()
      .p("Ah8CQQhjABgBhlIAAhYQABhjBjgBID4AAQBlABgBBjIAABYQABBlhlgBg");
    this.shape.setTransform(205.4, 24.1);

    this.addChild(this.shape);
  }).prototype = p = new cjs.Container();
  p.nominalBounds = new cjs.Rectangle(182.9, 9.6, 45, 29);

  (lib.SoldierRihgtlag1 = function () {
    this.initialize();
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AhoFgQgMgmgpkvQgpktAZgRQC0i0CjDBQgGDphbGXQgrAxgsAAQgrAAgvgrgAC2kWIAAABIABAKIgBgLg",
      );
  ...
  (lib.SoldierRightlag2 = function () {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AhZDnQAOgYgFgrIgKhwQgHhCgFhFQgFg/AFhYQBtA+BigzIhPGXQACAThPAZQgYAHgJAAQgHAAACgEg",
      );
    ...
    this.shape_1.graphics
      .f("#999999")
      .s()
      .p("AhsBmIACgTQAGhZALhkQBxhCBVBUIAACaIgJAvQgtAXgvAAQg3AAg9gig");
  ...
  (lib.Soldierrighthand2 = function () {
    this.initialize();
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AgVgOQAAAAABgBQAAAAABgBQAAAAAAgBQAAAAgBgBIAnARIADgDQAEALAAAKIgJgBQgNADgHAAQgfAAANghg",
      );
    ...
    this.shape_1.graphics
      .f("#515151")
      .s()
      .p("Ag7AcQAAgKgEgMIgDgGIBpgiIASAFQAKAEgBAPQAAANgIAIIh1AYIAAgHg");
  ...
  (lib.SoldierRighthand1 = function () {
    this.initialize();
    ...
    this.shape.graphics
      .f("#515151")
      .s()
      .p("AhBAGQA1gtA2gNQArANgZAlIgGAEQgQAThWAgQgbgSAKgdg");
  ...
  (lib.SoldierLeftlag2 = function () {
    ...
    this.shape_1.graphics
      ...
      .s()
      .p(
        "AhZDfQAOgXgFgsIgKhvQgHhCgFhFQgFg/AFhYQBtA9BigyIgtHCQALAAioAWQADgJAFgKg",
      );
  ...
  (lib.SoldierLeftlag1 = function () {
    ...
    this.shape.graphics
      .f("#848484")
      .s()
      .p("AhhFgQgMgmgpkvQgpktAZgRQC0i0CjDBQgGDphbGXQgrAxgsAAQgsAAgugrg");
  ...
  (lib.Soldierlefthand2 = function () {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AgQAPQgLgKADgHQADgKAFgCQAVgIAOASIACgCQAFAKAAAKIgJAAQgLAEgHAAQgIAAgHgDg",
      );
    ...
    this.shape_1.graphics
      .f("#999999")
      .s()
      .p("Ag7AcQAAgKgEgMIgDgGIBpgiQAIACAKADQAKAEAAAPQgBANgIAIIh0AYIgBgHg");
  ...
  (lib.Soldierlefthand1 = function () {
    ...
    this.shape.graphics
      .f("#999999")
      .s()
      .p("AhBAGQA1gtA2gNQArAMgZAmIgGAEQgQAShXAhQgagSAKgdg");
    this.shape.setTransform(6.9, 5.4);
  ...
  (lib.SoldierFruntview = function () {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AACFvIAAgFIgCADIgBgDIAAAEQlPERmDgmIAAh9QGDAZFPkiIABgCIACACQFPEjGDgaIgBB9QgwAFgvAAQlMAAkmjvgAACjCIgDAAQg+ABg4AJIgOllQCSiACVCAIgMFqQhHgOhNgBg",
      );
    ...
    this.shape_1.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_2.graphics
      ...
      .s()
      .p(
        "AReZxQiumdBkp4Qk8pNFKk7QljmtFpnLQMEADjZNkQCmJYkxGYQD0HOinHwgA5/ZxIAAhyQgjlzA6mBQA6mBg4jDQg4jCBWlCQjYtfL5gIIAKAAQBUBpAtBpQBRC7gqC2QgjCdh/CYQApAnAiAqQA3BEAXBHQBGFcj8HLQBrF4jzIigAqHzXQDyg0BkgRIAAlUII0AGIAAFHIFbA+QkrEZk8AAQk2AAlIkLg",
      );
    ...
    this.shape_3.graphics
      ...
      .s()
      .p(
        "AyMWrQDyoihrl4QD9nLhHlcQgXhGg3hEQghgqgpgnQB+iZAkidQApi2hRi7QgthohThqIgKAAQEGgRCagiQKWIcJOopIHLBAQlpHLFjGuQlLE8E8JLQhjJ4CtGdg",
      );
    ...
    this.shape_4.graphics
      ...
      .s()
      .p(
        "AljNTQg0jEg0grQg1gshRkSQhSkSgImxQgKmzDbhDQDbhDD2AAQD0AADjAvQDhAvgCJ9QgDJ6ivC7QivC7h0DDQipAfh1AAQj6AAgjiEg",
      );
  ...
  (lib.SmokeBlast = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_2.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_3.graphics
      ...
      .s()
      .p(
        "",
      );
  ...
  (lib.Rightlag2 = function () {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "Ai2EaQgQgXgEgXQgEgWAOgXQANgYgEgrIgLhwQgGhCgFhFQgGhFAHhlQBTBBBag4QgrEsgBCAQADAoCrAOQBPgTAYAjQAVAcgtAJQgxAIgGAAQgLgBgFAFIgYAQQgTAMgjgEQgfgCgmgHQgmgIgnAPQgVAJgPAAQgSAAgLgMg",
      );
    ...
    this.shape_1.graphics
      .f("#FEB288")
      .s()
      .p("AhrBcQAGhbALhiQBxhCBVBUIgsC0QgqAagmAAQgvAAgsgjg");
  ...
  (lib.Lefthand = function () {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AAFHOQg1gQgmgoQgjgkAAgWQgDgUACgJQACgLAgg3QAeg4AWgIQAWgJASAVQAgAgAuBCQAUgkgIg1QgJg1gIghQgJgggTg7QgTg5gogcQgpgbgKgYQgKgYAFhIQAEhIgRgIQgRgJgZgVQgZgXgggkQgogsA5gzIAhAFQAZgNBEAMQBBANAxBXQAyBWgDBMQgEBKAmBqQAmBngDB7QgEB6gRAYQgTAYgwAxQgkAmgoAAQgNAAgNgEg",
      );
  ...
  (lib.gd46 = function () {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AgCAFQgFAAgBgDQgBAAgBgBQAAAAgBgBQAAAAAAAAQAAAAABAAQACgDAFgBQADgBACABQAHAAACACQACACgCACQAAAAgBABQAAAAAAABQgBAAAAAAQgBABgBAAIgGABIgDgBg",
      );
    ...
    this.shape_1.graphics
      ...
      .s()
      .p(
        "AgJAEQgDgDABgBIAHgDQAEgCADAAQAFACADACQAAABABAAQAAAAAAAAQAAAAAAAAQgBABAAAAQAAADgEABIgJABQgFgBgCgBg",
      );
  ...
  (lib.breakdh53 = function () {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AlVB7QgFAAgDgEQgDgDgBgFIAAjdQABgFADgDQADgEAFAAIKqAAQAGAAADAEQAEADAAAFIAADdQAAAFgEADQgDAEgGAAg",
      );
  ...
  (lib.gate_3ss = function () {
    ...
    this.shape.graphics
      ...
      .s()
      .p("AjWB7QgGAAgCgDQgEgEAAgFIAAjdQAAgFAEgDQACgEAGAAIG5AAIAAD1g");
  ...
  (lib.gate_2 = function () {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AlVB7QgFAAgDgEQgDgDAAgFIAAjdQAAgFADgDQADgEAFAAIKrAAQAFAAADAEQADADAAAFIAADdQAAAFgDADQgDAEgFAAg",
      );
    this.shape.setTransform(35.4, 12.3);
  ...
  (lib.ClipGroupcopy2 = function () {
    ...
    mask._off = true;
    mask.graphics.p(
      "AhDBEQgcgcgBgoQABgmAcgdQAdgcAmgBQAoABAcAcQAdAdAAAmQAAAogdAcQgcAdgoAAQgmAAgdgdg",
    );
    ...
    this.shape.graphics
      .rf(
        ...
        [0, 0.122, 0.271, 0.427, 0.596, 0.663, 0.965, 1],
        -0.4,
        -2.1,
        0,
        -0.4,
  ...
  (lib.ClipGroup_17copy2 = function () {
    this.initialize();
    ...
    mask._off = true;
    mask.graphics.p(
      "Ag8BAQgbgZgBgmQgBgjAZgbQAagbAlgBIABAAQAkAAAaAaQAbAZAAAlQABAjgZAbQgaAbglABIgCABQgiAAgagag",
    );
  ...
  (lib.ClipGroup_16copy2 = function () {
    this.initialize();
    ...
    mask._off = true;
    mask.graphics.p(
      "AhCDXQgjgjgTg6QgBgUgJgmQgKgngBgWQgChmAohKQAnhKA7gCIACAAQA5AAAqBIQArBIADBmQACBmgnBKQgoBKg7ACIgCABQglAAghgjg",
    );
    ...
    this.shape.graphics
      .lf(
        ...
        [0, 0.016, 0.043, 0.094, 0.38, 0.459, 0.506, 0.651, 0.859, 1],
        0.7,
        25,
        -0.6,
        -25,
  ...
  (lib.ClipGroup_16copy = function () {
    ...
    this.shape.graphics
      ...
      .s()
      .p("AAEDXQgggigUg7QAAgUgKgmQgJgngBgWQgDhlAohKQAlhJA5gDIAGHxQgigDgfgfg");
  ...
  (lib.ClipGroup_15copy2 = function () {
    this.initialize();
    ...
    this.shape.graphics
      .lf(
        ...
        [
          0, 0.722, 0.722, 0.733, 0.749, 0.765, 0.78, 0.804, 0.906, 0.957,
          0.984, 1,
        ],
        0.6,
        21.9,
    ...
    this.shape_1.graphics
      .lf(
        ...
        [
          0, 0.141, 0.243, 0.349, 0.494, 0.541, 0.58, 0.616, 0.655, 0.686, 0.71,
          0.71, 0.722, 0.722, 1,
        ],
        0.6,
        21.9,
  ...
  (lib.ClipGroup_14copy2 = function () {
    this.initialize();
    ...
    this.shape_1.graphics
      .f("#000000")
      .s()
      .p("AgCDrIgMnUQAJgHAHgDIANHnQgKgDgHgGg");
  ...
  (lib.ClipGroup_13copy2 = function () {
    this.initialize();
    ...
    mask._off = true;
    mask.graphics.p(
      "AgSD/QgFgGAAgIIgNngQAAgIAFgGQAEgGAGAAIAdgBQAHAAAEAGQAFAGAAAIIANHfQAAAIgEAGQgFAGgGABIgdAAIgBABQgGAAgEgGg",
    );
    ...
    this.shape.graphics
      .lf(
        ...
        [
          0, 0.722, 0.722, 0.737, 0.749, 0.765, 0.78, 0.804, 0.906, 0.957,
          0.984, 1,
        ],
        0.7,
        26.1,
    ...
    this.shape_1.graphics
      .lf(
        ...
        [
          0, 0.141, 0.243, 0.349, 0.494, 0.541, 0.58, 0.62, 0.655, 0.69, 0.71,
          0.71, 0.722, 0.722, 1,
        ],
        0.7,
        26.1,
  ...
  (lib.ClipGroup_12copy2 = function () {
    this.initialize();
  ...
  (lib.ClipGroup_11copy2 = function () {
    this.initialize();
    ...
    mask._off = true;
    mask.graphics.p(
      "AgTDSQgFgEAAgIIgKmKQgBgHAFgEQAEgFAGgBIAegBQAGABAEAEQAFAFAAAGIALGLQgBAHgEAEQgEAGgHAAIgcABQgGgBgFgEg",
    );
  ...
  (lib.ClipGroup_10copy2 = function () {
    this.initialize();
    ...
    mask._off = true;
    mask.graphics.p(
      "AgTDbQgEgFgBgHIgLmcQAAgHAFgFQAEgFAGAAIAdgBQAHAAAEAFQAFAFAAAHIALGcQAAAGgEAGQgFAFgGAAIgdABIgBAAQgGAAgEgFg",
    );
  ...
  (lib.ClipGroup_9copy2 = function () {
    ...
    mask._off = true;
    mask.graphics.p(
      "AgSDmQgFgFAAgIIgMmwQAAgIAEgFQAFgFAGgBIAdAAQAHAAAEAFQAFAFAAAHIALGxQAAAHgEAGQgEAFgHAAIgcABQgHAAgEgFg",
    );
  ...
  (lib.ClipGroup_8copy2 = function () {
    ...
    mask._off = true;
    mask.graphics.p(
      "AgSD6QgFgGAAgIIgNnWQAAgIAFgGQAEgFAGgBIAdAAQAHAAAEAFQAFAGAAAIIAMHVQABAIgFAGQgEAGgHAAIgcABIgBAAQgGAAgEgFg",
    );
  ...
  (lib.ClipGroup_7copy2 = function () {
    ...
    this.shape.graphics
      .f("#000000")
      .s()
      .p("AgOgaQgBghAEgfIACAAQAJAAAGAcQAIAcABAmQABA8gMAbQgQg2gCg/g");
  ...
  (lib.ClipGroup_2copy3 = function () {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AiZCbQhBhBAAhaQAAhZBBhBQBAhABZAAQBbAAA/BAQBBBBAABZQAABahBBBQg/BAhbAAQhZAAhAhAg",
      );
  ...
  (lib.ClipGroup_2 = function () {
    ...
    mask._off = true;
    mask.graphics.p(
      "AkeBjQgQgBAAgMIAAhHQAAgLAJgEIAHgDICMAAQAGAAAGgDQAEgEACgCQAVgnAlgYQAngXAsAAQAtAAAmAXQAmAXAVAmQAGALAOAAIBtAAIAJADQAKADAAALIAABFQAAAKgJAEIgIACg",
    );
  ...
  (lib.ClipGroup_1copy4 = function () {
    ...
    this.shape.graphics
      .rf(
        ...
        [0, 0.396, 0.475, 0.651, 0.745, 0.839, 0.965, 1],
        8.3,
        -9.8,
        0,
        8.3,
  ...
  (lib.ClipGroup_1copy2 = function () {
    ...
    this.shape.graphics
      .f("#000000")
      .s()
      .p("AhlBPQgKgVAAgZQAAgtAhghQAhghAtAAQAuAAAhAhQAhAhAAAtQAAAYgJAWg");
    ...
    this.shape_1.graphics
      ...
      .s()
      .p(
        "AkeBjQgQAAAAgNIAAhGQAAgMAJgEQADgCAEgBICMAAQAGAAAGgDIAGgHQAVgmAlgXQAngYAsAAQAtAAAmAXQAmAXAVAmQAFALAPAAIBtAAIAKADQAJADAAALIAABFQAAAKgJAEIgIACg",
      );
  ...
  (lib.ClipGroup_1 = function () {
    ...
    this.shape_1.graphics
      .f("#4E3B30")
      .s()
      .p("Ag+AQQgcgUgHghIDDAAQgHAhgbAUQgcAWgkAAQgjAAgbgWg");
  ...
  (lib.Body = function () {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "ABiG+Qh3ggh+g+Qh/g+gdhDQgdhEAnhdQgchwCZiaQgQhiAhhNQAmhMA8gbQAWgMAQgFQAdgLApAMIAIABIAKADQAGACAeA7QALAbALAmQAbBuhzC0QARCXiBBYQAbgRA6BHIBoCUIDEgCQgJADAIAOQAAB/hNAAQg0AAhYg7g",
      );
    ...
    this.shape_2.graphics
      ...
      .s()
      .p(
        "Ai0A7QAbgdgLhFICJghIA6gWICPBHQAaA6hHAAQgVgFgsgWIgGA3QgKAgg4AAQg8AAhwgkg",
      );
    ...
    this.shape_3.graphics
      ...
      .s()
      .p(
        "AjeA2IAAgXQALg/Asg8QAKgRARgQQAbgWAbgLQA9gWA/ALQAhAGAhAQQAbAQARARQgnAmgmgLQghgmAAgsQgFA3gkAWQg3gRgbgqQAhA2gcAwQg3gLggggQAmAxgLA1QggAlgrgPQAqARALA2QgQA2gnARQgWgmARhSgACZggQghgxAcghQA2AsAcAmQgcAFgTAAQgTAAgLgFg",
      );
    ...
    this.shape_4.graphics
      .f("#999999")
      .s()
      .p("AAuBoQARg3gng/Qg6gRghgsQgFgVAxgMQAqgFALA8IAmCBIAAAhg");
    ...
    this.shape_5.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_6.graphics
      ...
      .s()
      .p(
        "AjqCkQAngRAQg2QgLg2gqgRQArAPAgglQALg1gmgxQAgAgA3ALQAcgwghg2QAbAqA3ARQAkgWAFg3QAAAsAhAmQAmALAngmQgcAhAhAxQAWALA3gLIAWAWIgRAAQg2AQgGAOQgQgTgcgWQhBgxhQAQQhYAbgVBAQgRAhAAAhQgLAhAFAVIg2AhIgRgQg",
      );
    ...
    this.shape_7.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_8.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_9.graphics
      ...
      .s()
      .p(
        "Ah+IHQgsgFgmgLQgsgMgmgQIghgLQAbhXARiJQAVjPAAhWIAAgsQAGhiAQi6QAFgsgFghQgFgmAFgLQAFgFAGAAQARgLBBAAIALAAIBtAAIAaAAQBSgGArAAQA8AAAiAGQALAFAFAAQAmAQAhCaQAhCTgmBzQghBxghBHQgnBHAnB+QAmB4AGAsQAFAFAAAGQgQAFgWAGIAAAFQgWAFgLAGQhBARhCAFQg3ALg1AAQg2AAgxgLg",
      );
  ...
  (lib.Bg = function () {
    ...
    this.shape_1.graphics
      .f("#438F43")
      .s()
      .p("EhP/ASZMAAAgjgQFvArBah8QBfFhD5BtQD6BtEQi4IB2iSUBCjAFqBG7gIEMAAAAjag");
    ...
    this.shape_2.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_3.graphics
      ...
      .s()
      .p(
        "EgsDAG7QF8jaHAi6QLFklKkh5QK+h+LJBvQKMBmJlEiQAAgVgMgaQANAGAIANQAEAHAGATQAFgUgHgeQgDgMgNgkQARAQALAbQAGAQAKAgQALgKAAgaIAEArIAhgYQAVgPARAAIgeAkQgRATgFATQAbgTAyAHIgeAMQgRAHgLAIQFWCsEyDdg",
      );
    ...
    this.shape_4.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_5.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_6.graphics
      ...
      .s()
      .p(
        "EgsCAG7QF7jaHAi6QLFklKkh5QK+h+LJBvQKMBmJmEiQgBgXgMgXQAOAFAHANQAEAHAGATQAGgUgHgdQgEgOgMgjQARAQAKAbQAGAQAKAhQAMgLAAgaQABANABAeIAhgYQAXgPAQAAIgeAkQgRATgFATQAbgUAyAIIgeAMQgRAHgKAIQFWCtExDcg",
      );
    ...
    this.shape_7.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_8.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_9.graphics
      .f("#94C783")
      .s()
      .p("Ax7GiQDRjOD3ivQGHkVFzhyQGEh4GJBqQCWAoCSBIIAAKig");
    ...
    this.shape_10.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_11.graphics
      ...
      .s()
      .p(
        "AsTFrIAAs/IAFASQAIg0gBgaQAAgmgMglIAAgFQAWAgAJAqQAKApgCA6QAKgQASgqQAPgnAOgRIgNA0QgHAgAFAWQASgiAdgRQAagQAfAAQgjAWgeBBQCmAPBLAaQBwAkAEBOQAFBZCAAkQA3AQOOLgQukgTqDjjg",
      );
    ...
    this.shape_12.graphics
      ...
      .s()
      .p(
        "A7FGaIAAp7QA4glA4gjQHvk4HYiAQHqiEHvB2QHHBrGsEzQgBgXgHgcQAIAGAFAOQADAIAFAUQADgVgEggQgCgNgKgmQAMASAIAcIALAzQAIgMAAgbIACAwIAYgbQAPgRALAAIgVAnQgMAVgDAUQATgUAiAIIgVAMQgMAIgHAIQDvC3DUDmQvQKpvVAAQrwAAr1mOg",
      );
    ...
    this.shape_13.graphics
      ...
      .s()
      .p(
        "",
      );
    this.shape_13.setTransform(187.8, 533);

    this.shape_14 = new cjs.Shape();
    this.shape_14.graphics
      .f("rgba(255,255,255,0.698)")
      .s()
      .p("EhP/A/IMAAAh+PMCf/AAAMAAAB+Pg");
    ...
    this.shape_15.graphics
      ...
      .s()
      .p(
        "AliClQjzgnhtAFQhEAEg4gDQgZgUAegUQAbgSBogkQgFhtCSgOQB2gMCfAxQgLhVBjgZQBPgUBaAYQBKhCBTAgQBFAbA5BUQB4g4BSAhQBHAdgDA8QBKgNA3AqQAXASAGATQAGAUgQAKQAlAAAvAMQAuAMAfAQQg6ADifgDQhpgBAcAIQBPAWAUAIQApAQg2AAQhZAAndAUIg6ABQieAAjPgig",
      );
    ...
    this.shape_16.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_17.graphics
      ...
      .s()
      .p(
        "AliCmQjygohuAGQhFADg3gDQgZgUAegUQAbgSBogkQgFhtCTgOQB2gMCeAxQgLhVBjgYQBQgVBZAZQBKhDBTAgQBFAbA5BUQB4g4BTAhQBGAdgDA8QBKgNA4AqQAWASAGATQAGAUgQAKQAlAAAvAMQAuAMAfAQQg7ADiegCQhpgCAcAIQBTAYAQAGQApAQg2AAQhhAAnVAUIg3ABQifAAjRghg",
      );
    ...
    this.shape_18.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_19.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.shape_22.graphics
      ...
      .s("#B5B838")
      .ss(1, 1, 1)
      .p("ApokzIFuAWIhtDUAGXAiIDSDUAmggGIg6E5");
  ...
  (lib.Windows = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(mask)
        ...
        .wait(50)
        .to({ graphics: mask_graphics_50, x: 68, y: 175.1 })
        .wait(1)
        .to({ graphics: mask_graphics_51, x: 68, y: 179.1 })
        .wait(1)
        .to({ graphics: mask_graphics_52, x: 68, y: 183.2 })
        .wait(1)
        .to({ graphics: mask_graphics_53, x: 68, y: 187.2 })
        .wait(1)
        .to({ graphics: mask_graphics_54, x: 68, y: 191.2 })
        .wait(1)
        .to({ graphics: mask_graphics_55, x: 68, y: 195.3 })
        .wait(1)
        .to({ graphics: mask_graphics_56, x: 68, y: 199.3 })
        .wait(1)
        .to({ graphics: mask_graphics_57, x: 68, y: 203.3 })
        .wait(1)
        .to({ graphics: mask_graphics_58, x: 68, y: 207.4 })
        .wait(1)
        .to({ graphics: mask_graphics_59, x: 68, y: 211.4 })
        .wait(1)
        .to({ graphics: mask_graphics_60, x: 68, y: 215.4 })
        .wait(1)
        .to({ graphics: mask_graphics_61, x: 68, y: 219.5 })
        .wait(1)
        .to({ graphics: mask_graphics_62, x: 68, y: 223.5 })
        .wait(1)
        .to({ graphics: mask_graphics_63, x: 68, y: 227.5 })
        .wait(1)
        .to({ graphics: mask_graphics_64, x: 68, y: 231.6 })
        .wait(1)
        .to({ graphics: mask_graphics_65, x: 68, y: 235.6 })
        .wait(1)
        .to({ graphics: mask_graphics_66, x: 68, y: 239.6 })
        .wait(1)
        .to({ graphics: mask_graphics_67, x: 68, y: 243.7 })
        .wait(1),
    );
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.timeline.addTween(
      cjs.Tween.get({})
        .to({ state: [] })
        .to({ state: [{ t: this.shape_1 }, { t: this.shape }] }, 50)
        .wait(18),
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(mask_1)
        .to({ graphics: null, x: 0, y: 0 })
        .wait(50)
        .to({ graphics: mask_1_graphics_50, x: 42.1, y: 86.5 })
        .wait(1)
        .to({ graphics: mask_1_graphics_51, x: 42.1, y: 90.5 })
        .wait(1)
        .to({ graphics: mask_1_graphics_52, x: 42.1, y: 94.5 })
        .wait(1)
        .to({ graphics: mask_1_graphics_53, x: 42.1, y: 98.6 })
        .wait(1)
        .to({ graphics: mask_1_graphics_54, x: 42.1, y: 102.6 })
        .wait(1)
        .to({ graphics: mask_1_graphics_55, x: 42.1, y: 106.6 })
        .wait(1)
        .to({ graphics: mask_1_graphics_56, x: 42.1, y: 110.7 })
        .wait(1)
        .to({ graphics: mask_1_graphics_57, x: 42.1, y: 114.7 })
        .wait(1)
        .to({ graphics: mask_1_graphics_58, x: 42.1, y: 118.7 })
        .wait(1)
        .to({ graphics: mask_1_graphics_59, x: 42.1, y: 122.8 })
        .wait(1)
        .to({ graphics: mask_1_graphics_60, x: 42.1, y: 126.8 })
        .wait(1)
        .to({ graphics: mask_1_graphics_61, x: 42.1, y: 130.8 })
        .wait(1)
        .to({ graphics: mask_1_graphics_62, x: 42.1, y: 134.9 })
        .wait(1)
        .to({ graphics: mask_1_graphics_63, x: 42.1, y: 138.9 })
        .wait(1)
        .to({ graphics: mask_1_graphics_64, x: 42.1, y: 142.9 })
        .wait(1)
        .to({ graphics: mask_1_graphics_65, x: 42.1, y: 146.9 })
        .wait(1)
        .to({ graphics: mask_1_graphics_66, x: 42.1, y: 151 })
        .wait(1)
        .to({ graphics: mask_1_graphics_67, x: 42.1, y: 155 })
        .wait(1),
    );
    ...
    this.shape_2.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.timeline.addTween(
      cjs.Tween.get({})
        .to({ state: [] })
        .to({ state: [{ t: this.shape_3 }, { t: this.shape_2 }] }, 50)
        .wait(18),
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(mask_2)
        .to({ graphics: null, x: 0, y: 0 })
        .wait(50)
        .to({ graphics: mask_2_graphics_50, x: 10.1, y: 35.8 })
        .wait(1)
        .to({ graphics: mask_2_graphics_51, x: 10.1, y: 39.8 })
        .wait(1)
        .to({ graphics: mask_2_graphics_52, x: 10.1, y: 43.8 })
        .wait(1)
        .to({ graphics: mask_2_graphics_53, x: 10.1, y: 47.9 })
        .wait(1)
        .to({ graphics: mask_2_graphics_54, x: 10.1, y: 51.9 })
        .wait(1)
        .to({ graphics: mask_2_graphics_55, x: 10.1, y: 55.9 })
        .wait(1)
        .to({ graphics: mask_2_graphics_56, x: 10.1, y: 60 })
        .wait(1)
        .to({ graphics: mask_2_graphics_57, x: 10.1, y: 64 })
        .wait(1)
        .to({ graphics: mask_2_graphics_58, x: 10.1, y: 68 })
        .wait(1)
        .to({ graphics: mask_2_graphics_59, x: 10.1, y: 72.1 })
        .wait(1)
        .to({ graphics: mask_2_graphics_60, x: 10.1, y: 76.1 })
        .wait(1)
        .to({ graphics: mask_2_graphics_61, x: 10.1, y: 80.1 })
        .wait(1)
        .to({ graphics: mask_2_graphics_62, x: 10.1, y: 84.2 })
        .wait(1)
        .to({ graphics: mask_2_graphics_63, x: 10.1, y: 88.2 })
        .wait(1)
        .to({ graphics: mask_2_graphics_64, x: 10.1, y: 92.2 })
        .wait(1)
        .to({ graphics: mask_2_graphics_65, x: 10.1, y: 96.2 })
        .wait(1)
        .to({ graphics: mask_2_graphics_66, x: 10.1, y: 100.3 })
        .wait(1)
        .to({ graphics: mask_2_graphics_67, x: 10.1, y: 104.3 })
        .wait(1),
    );
    ...
    this.shape_4.graphics
      ...
      .s()
      .p(
        "",
      );
    ...
    this.timeline.addTween(
      cjs.Tween.get({})
        .to({ state: [] })
        .to({ state: [{ t: this.shape_5 }, { t: this.shape_4 }] }, 50)
        .wait(18),
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get({})
        .to({ state: [] })
        .to({ state: [{ t: this.instance, p: { x: 19, y: 206.6 } }] }, 1)
        .to({ state: [] }, 5)
        .to(
          {
            state: [
              { t: this.instance_1, p: { x: 69.3, y: 167.3 } },
              { t: this.instance, p: { x: 19.2, y: 206.6 } },
            ],
          },
          6,
        )
        ...
        .to(
          {
            state: [
              { t: this.instance_2, p: { x: 69.3, y: 167.3 } },
              { t: this.instance_1, p: { x: 43.1, y: 78.7 } },
              { t: this.instance, p: { x: 19.2, y: 206.6 } },
            ],
          },
          7,
        ...
        .to(
          {
            state: [
              { t: this.instance_2, p: { x: 11.3, y: 27.9 } },
              { t: this.instance_1, p: { x: 43.1, y: 78.7 } },
              { t: this.instance, p: { x: 69.4, y: 167.3 } },
            ],
          },
          8,
        )
  ...
  (lib.Symbol3 = function () {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AMWFWIAAqrMAgrAAAQBkAAAABkIAAHjQAABkhkAAgAAwFWIAAqmILLAAIAAKmgEgtAAFWQhkAAAAhsIAAnOQAAhsBkAAMAtXAAAIAAKmg",
      );
    this.shape.setTransform(312.2, 28.8);
    ...
    this.addChild(this.shape_1, this.ikNode_1, this.shape);
  }).prototype = p = new cjs.Container();
  p.nominalBounds = new cjs.Rectangle(0, -5.5, 819.2, 68.5);

  (lib.Sodierwithbody = function () {
    this.initialize();
    ...
    this.shape.graphics
      ...
      .s("#999999")
      .ss(1, 1, 1)
      .p("AAvgEIgBABQgPAHgSACQgBAAAAAAQgLAAgLgCQgNgCgOgEQgFgBgEgC");
    ...
    this.shape_1.graphics
      ...
      .s()
      .p(
        "AgGAqIgBgNQgKAFgEABQgKAAgCgEQABgDgBgDQgBgFgHgCIAHgFIgGgDIAHgGQgIAAgEgEQAGgIADgRQgDgLAHgMQAOAGANACQALACALAAQgHAPABAMQAAAaAfAMQAAAJAEAFQgZAIgOAAQgKAAgDgHg",
      );
    ...
    this.shape_2.graphics
      ...
      .s()
      .p(
        "AAjA+IgHgCQgegNABgbQAAgNAFgNQASgBAPgKIABAAQADAJgCAGQgBAfAHAJIAJAOQAGAIgNACgAgTgHQgNgDgOgFIgJgEQADgKAGgKQAFgGAHgGQASgNAUAEQAXAHAGASQAFAJAAAJIgBAAQgPAKgSABIgBAAIgDAAQgJAAgKgBgAAmgRIAAAAg",
      );
    ...
    this.shape_3.graphics
      .f("#9E2757")
      .s()
      .p("Ag6AEQgEgTAGgDQA/ATAugUQAJAPgCAEIgEAIQgeAMgaAAQgeAAgcgQg");
    ...
    this.shape_4.graphics
      ...
      .s()
      .p(
        "AAwCgQgHgIgNggQgBBHh+g8QAWgQAHgSQAHgRADgaQACgZACgFIACgJQAzAfA/gbQAAAJAGAkQAGAkAcArQgXAUgRAAQgHAAgFgDgAg0gHIgFhAQgGhBAzgaIAAAAIAJABIAEAAIAZAAIADAAQAbAOAMApQACAVgCAWQgCAYgJAfQgYAJgdAAQgZAAgfgIg",
      );
  ...
  (lib.part_2826 = function () {
    ...
    this.shape.graphics
      .f("rgba(0,0,0,0.349)")
      .s()
      .p("AC3GKIAAsTICmAAIAACEIAAEEIAAGLgAlcGKIAAhIIAAlDIAAkEIAAiEICwAAIAAMTg");
    this.shape.setTransform(72.6, 49.9);

    this.shape_1 = new cjs.Shape();
    this.shape_1.graphics
      .f("rgba(255,255,255,0.078)")
      .s()
      .p("AixGKIAAsTIFjAAIAAMTg");
  ...
  (lib.part_314 = function () {
    ...
    this.shape.graphics
      .f("rgba(0,0,0,0.349)")
      .s()
      .p("AC3ExIAAphICmAAIAADWIAAGLgAlcExIAAhIIAAlDIAAjWICwAAIAAJhg");
  ...
  (lib.mc_soldierSideview2 = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance)
        ...
        .to({ scaleX: 1, scaleY: 1, rotation: -13.3, x: 230.6, y: -38.9 }, 7)
        .to(
          {
            regX: 50.1,
            scaleX: 1,
        ...
        .wait(4)
        .to({ regX: 50.2, regY: 117.8, rotation: -70.9, x: 22.2, y: 307.6 }, 0)
        .wait(1),
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_1)
        .to({ regX: 1.7, rotation: 88.7, x: 509.6, y: 239.7 }, 3)
        .to(
          { scaleX: 1.05, scaleY: 1.05, rotation: 24.3, x: 259.1, y: 80.1 },
          7,
        )
        .to(
          {
        ...
        .wait(4)
        .to({ rotation: -97.2, x: 161.5, y: 353.8 }, 0)
        .wait(1),
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_2)
        .to({ regY: 0.2, rotation: 4.7, x: 513.4, y: 180.1 }, 3)
        .to(
          {
            regX: 17.5,
            scaleX: 1.05,
        ...
        .wait(4)
        .to({ rotation: -96.2, x: 87.5, y: 349.5 }, 0)
        .wait(1),
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_3)
        .to({ regX: 1.7, regY: 0.5, rotation: -20, x: 552.2, y: 244.5 }, 3)
        .to(
          {
            regX: 1.6,
            scaleX: 1.05,
        ...
        .wait(4)
        .to({ rotation: -95.9, x: 161.4, y: 319.2 }, 0)
        .wait(1),
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_4)
        .to({ regX: 17.5, regY: 0.3, rotation: -40.5, x: 517.4, y: 188.2 }, 3)
        .to(
          {
            regX: 17.6,
            scaleX: 1.05,
        ...
        .wait(4)
        .to({ regX: 17.4, regY: 0.2, rotation: -116.4, x: 98.3, y: 339.3 }, 0)
        .wait(1),
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_5)
        .to({ startPosition: 0 }, 3)
        .to({ scaleX: 1, scaleY: 1, rotation: -19.8, x: 12.9, y: -40.3 }, 7)
        .to(
          {
            regX: 50.1,
            scaleX: 1,
        ...
        .wait(4)
        .to({ rotation: -78.9, x: -263.7, y: 295.9 }, 0)
        .wait(1),
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_6)
        .to({ regX: 1.7, rotation: 88.7, x: 321.1, y: 239.7 }, 3)
        .to(
          {
            regX: 1.8,
            regY: 0.5,
        ...
        .wait(4)
        .to({ regX: 1.7, rotation: -102.1, x: -95.9, y: 346.7 }, 0)
        .wait(1),
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_7)
        .to({ regY: 0.2, rotation: 4.7, x: 324.9, y: 180.1 }, 3)
        .to(
          { scaleX: 1.05, scaleY: 1.05, rotation: -20.8, x: 28.7, y: 18.1 },
          7,
        )
        .to(
          {
        ...
        .wait(4)
        .to({ regY: 0.1, rotation: -83.5, x: -175.2, y: 324.4 }, 0)
        .wait(1),
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_8)
        .to({ regX: 1.7, regY: 0.5, rotation: -20, x: 363.7, y: 244.5 }, 3)
        .to(
          { scaleX: 1.05, scaleY: 1.05, rotation: -39.9, x: 93.9, y: 63.7 },
          7,
        )
        .to(
          {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_9)
        .to({ regX: 17.5, regY: 0.3, rotation: -40.5, x: 328.9, y: 188.2 }, 3)
        .to(
          {
            regX: 17.4,
            regY: 0.2,
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_10)
        ...
        .wait(4)
        .to({ regY: 117.7, rotation: 74.9, x: -304.1, y: 269.2 }, 0)
        .wait(1),
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_12)
        .to({ regX: 1.7, rotation: 88.7, x: 132.6, y: 239.7 }, 3)
        .to({ x: -173.1, y: 83.6 }, 7)
        .to({ x: -370.8, y: 344.4 }, 7)
        .wait(4)
        .to({ x: -395.8, y: 351.7 }, 0)
        .wait(1),
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_13)
        .to({ regY: 0.2, rotation: 4.7, x: 136.4, y: 180.1 }, 3)
        .to({ regY: 0.3, rotation: -0.3, x: -175.1, y: 23.4 }, 7)
        .to({ regX: 17.6, rotation: -7, x: -379.7, y: 283.3 }, 7)
        .wait(4)
        .to({ x: -404.7, y: 290.6 }, 0)
        .wait(1),
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_14)
        .to({ regX: 1.7, regY: 0.5, rotation: -20, x: 175.2, y: 244.5 }, 3)
        .to(
          { scaleX: 1.05, scaleY: 1.05, rotation: 23.3, x: -161.6, y: 74.1 },
          7,
        )
        .to(
          { scaleX: 1.05, scaleY: 1.05, rotation: 77.8, x: -398.2, y: 317.2 },
          7,
        )
        .wait(4)
        .to({ x: -429.5, y: 296 }, 0)
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_15)
        .to({ regX: 17.5, regY: 0.3, rotation: -40.5, x: 140.4, y: 188.2 }, 3)
        .to({ regX: 17.6, rotation: -5.5, x: -163.6, y: 25.5 }, 7)
        .to({ regX: 17.5, regY: 0.2, rotation: 38, x: -359.5, y: 278.3 }, 7)
        .wait(4)
        .to({ x: -390.8, y: 257 }, 0)
        .wait(1),
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_16)
        .to({ startPosition: 0 }, 3)
        .to({ x: -111.8, y: -21.4 }, 7)
        .to({ x: -286.3, y: 243.1 }, 7)
        .wait(4)
        .to({ regX: 18.9, regY: 44.7, rotation: 75.2, x: -312.6, y: 294.5 }, 0)
        .wait(1),
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_17)
        ...
        .wait(4)
        .to({ rotation: -81, x: -240.7, y: 272.9 }, 0)
        .wait(1),
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_18)
        ...
        .to({ scaleX: 1, scaleY: 1, rotation: -30, x: 90.7, y: 218.6 }, 7)
        .wait(4)
        .to({ regX: 18.8, regY: 44.7, rotation: -70.9, x: 48.4, y: 297.3 }, 0)
        .wait(1),
    );
  }).prototype = p = new cjs.MovieClip();
  ...
  (lib.mc_soldierSideview = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_1)
        .to({ regX: 1.7, rotation: 88.7, x: 509.6, y: 239.7 }, 4)
        .to({ regY: 0.5, rotation: 103.7, x: 552.4, y: 295.1 }, 5)
        .to({ rotation: -22.3, x: 551.1, y: 246.3 }, 5)
        .to({ regX: 1.8, regY: 0.4, rotation: 23.2, x: 496, y: 259.9 }, 5)
        .to({ regX: 1.7, rotation: 88.7, x: 509.6, y: 239.7 }, 5)
        .to({ regX: 1.8, rotation: 4.3, x: 496.3, y: 233.8 }, 5)
        .wait(1),
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_2)
        .to({ regY: 0.2, rotation: 4.7, x: 513.4, y: 180.1 }, 4)
        .to({ regX: 17.5, rotation: -25.3, x: 517.6, y: 238.2 }, 5)
        .to({ regY: 0.3, rotation: -38.5, x: 516.8, y: 185.7 }, 5)
        .to({ regX: 17.4, regY: 0.2, rotation: 25.5, x: 533.4, y: 206.1 }, 5)
        .to({ rotation: 4.7, x: 513.4, y: 180.1 }, 5)
        .to({ regY: 0.1, rotation: 6.5, x: 514.2, y: 170.7 }, 5)
        .wait(1),
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_3)
        .to({ regX: 1.7, regY: 0.5, rotation: -20, x: 552.2, y: 244.5 }, 4)
        .to({ regX: 1.6, rotation: 24.2, x: 497.1, y: 268.7 }, 5)
        .to({ rotation: 87.6, x: 508.8, y: 238.6 }, 5)
        .to({ regX: 1.7, rotation: 103.6, x: 552.4, y: 286.2 }, 5)
        .to({ rotation: -20, x: 552.2, y: 244.5 }, 5)
        .to({ regX: 1.6, regY: 0.4, rotation: -0.7, x: 520.1, y: 235.8 }, 5)
        .wait(1),
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_4)
        .to({ regX: 17.5, regY: 0.3, rotation: -40.5, x: 517.4, y: 188.2 }, 4)
        .to({ regY: 0.2, rotation: 21.2, x: 528.4, y: 215.2 }, 5)
        .to({ rotation: 6.8, x: 515.2, y: 179.8 }, 5)
        .to({ regX: 17.4, rotation: -24.5, x: 518.5, y: 230.2 }, 5)
        .to({ regX: 17.5, regY: 0.3, rotation: -40.5, x: 517.4, y: 188.2 }, 5)
        .to({ regX: 17.6, regY: 0.2, rotation: -3.7, x: 526.1, y: 174.1 }, 5)
        .wait(1),
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_6)
        .to({ regX: 1.7, rotation: 88.7, x: 321.1, y: 239.7 }, 4)
        .to({ regY: 0.5, rotation: 103.7, x: 363.9, y: 295.1 }, 5)
        .to({ rotation: -22.3, x: 362.6, y: 246.3 }, 5)
        .to({ regX: 1.8, regY: 0.4, rotation: 23.2, x: 307.5, y: 259.9 }, 5)
        .to({ regX: 1.7, rotation: 88.7, x: 321.1, y: 239.7 }, 5)
        .to({ regX: 1.8, rotation: 4.3, x: 307.8, y: 233.8 }, 5)
        .wait(1),
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_7)
        .to({ regY: 0.2, rotation: 4.7, x: 324.9, y: 180.1 }, 4)
        .to({ regX: 17.5, rotation: -25.3, x: 329.1, y: 238.2 }, 5)
        .to({ regY: 0.3, rotation: -38.5, x: 328.3, y: 185.7 }, 5)
        .to({ regX: 17.4, regY: 0.2, rotation: 25.5, x: 344.9, y: 206.1 }, 5)
        .to({ rotation: 4.7, x: 324.9, y: 180.1 }, 5)
        .to({ regY: 0.1, rotation: 6.5, x: 325.7, y: 170.7 }, 5)
        .wait(1),
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_8)
        .to({ regX: 1.7, regY: 0.5, rotation: -20, x: 363.7, y: 244.5 }, 4)
        .to({ regX: 1.6, rotation: 24.2, x: 308.6, y: 268.7 }, 5)
        .to({ rotation: 87.6, x: 320.3, y: 238.6 }, 5)
        .to({ regX: 1.7, rotation: 103.6, x: 363.9, y: 286.2 }, 5)
        .to({ rotation: -20, x: 363.7, y: 244.5 }, 5)
        .to({ regX: 1.6, regY: 0.4, rotation: -0.7, x: 331.6, y: 235.8 }, 5)
        .wait(1),
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_9)
        .to({ regX: 17.5, regY: 0.3, rotation: -40.5, x: 328.9, y: 188.2 }, 4)
        .to({ regY: 0.2, rotation: 21.2, x: 339.9, y: 215.2 }, 5)
        .to({ rotation: 6.8, x: 326.7, y: 179.8 }, 5)
        .to({ regX: 17.4, rotation: -24.5, x: 330, y: 230.2 }, 5)
        .to({ regX: 17.5, regY: 0.3, rotation: -40.5, x: 328.9, y: 188.2 }, 5)
        .to({ regX: 17.6, regY: 0.2, rotation: -3.7, x: 337.6, y: 174.1 }, 5)
        .wait(1),
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_12)
        .to({ regX: 1.7, rotation: 88.7, x: 132.6, y: 239.7 }, 4)
        .to({ regY: 0.5, rotation: 103.7, x: 175.4, y: 295.1 }, 5)
        .to({ rotation: -22.3, x: 174.1, y: 246.3 }, 5)
        .to({ regX: 1.8, regY: 0.4, rotation: 23.2, x: 119, y: 259.9 }, 5)
        .to({ regX: 1.7, rotation: 88.7, x: 132.6, y: 239.7 }, 5)
        .to({ regX: 1.8, rotation: 4.3, x: 119.3, y: 233.8 }, 5)
        .wait(1),
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_13)
        .to({ regY: 0.2, rotation: 4.7, x: 136.4, y: 180.1 }, 4)
        .to({ regX: 17.5, rotation: -25.3, x: 140.6, y: 238.2 }, 5)
        .to({ regY: 0.3, rotation: -38.5, x: 139.8, y: 185.7 }, 5)
        .to({ regX: 17.4, regY: 0.2, rotation: 25.5, x: 156.4, y: 206.1 }, 5)
        .to({ rotation: 4.7, x: 136.4, y: 180.1 }, 5)
        .to({ regY: 0.1, rotation: 6.5, x: 137.2, y: 170.7 }, 5)
        .wait(1),
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_14)
        .to({ regX: 1.7, regY: 0.5, rotation: -20, x: 175.2, y: 244.5 }, 4)
        .to({ regX: 1.6, rotation: 24.2, x: 120.1, y: 268.7 }, 5)
        .to({ rotation: 87.6, x: 131.8, y: 238.6 }, 5)
        .to({ regX: 1.7, rotation: 103.6, x: 175.4, y: 286.2 }, 5)
        .to({ rotation: -20, x: 175.2, y: 244.5 }, 5)
        .to({ regX: 1.6, regY: 0.4, rotation: -0.7, x: 143.1, y: 235.8 }, 5)
        .wait(1),
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_15)
        .to({ regX: 17.5, regY: 0.3, rotation: -40.5, x: 140.4, y: 188.2 }, 4)
        .to({ regY: 0.2, rotation: 21.2, x: 151.4, y: 215.2 }, 5)
        .to({ rotation: 6.8, x: 138.2, y: 179.8 }, 5)
        .to({ regX: 17.4, rotation: -24.5, x: 141.5, y: 230.2 }, 5)
        .to({ regX: 17.5, regY: 0.3, rotation: -40.5, x: 140.4, y: 188.2 }, 5)
        .to({ regX: 17.6, regY: 0.2, rotation: -3.7, x: 149.1, y: 174.1 }, 5)
        .wait(1),
    );
  ...
  (lib.wall3dsfs = function () {
    ...
    this.shape.graphics
      .f("rgba(0,0,0,0.078)")
      .s()
      .p("Ag/FRIAAlJIAAkHIAAibIB4AAIAHMzIh/ABg");
    ...
    mask._off = true;
    mask.graphics.p(
      "",
    );
    ...
    this.shape_1.graphics
      .f("#76857B")
      .s()
      .p("Ag2GXIAAhIIAAlFIAAgBIAAkBIgCibIgRAAICTgDIAAMtg");
  ...
  p.nominalBounds = new cjs.Rectangle(6, 7.8, 19, 85.1);
  ...
  (lib.wall3 = function () {
    ...
    this.shape.graphics
      .f("rgba(0,0,0,0.078)")
      .s()
      .p("AgbF4IAAlKIAAkGIAAigIhHAGIAAhMIC+gCIAHOAIh+ABg");
    ...
    this.shape_2.graphics
      .f("#76857B")
      .s()
      .p("AgaG9IAAhIIAAlFIAAgBIAAkBIgCibIhGgBIgChOIDJAAIAAN5g");
  ...
  p.nominalBounds = new cjs.Rectangle(0.4, -0.1, 24.6, 93.9);

  (lib.ClipGroupcopy3 = function () {
    this.initialize();
  ...
  (lib.Door = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance)
        .wait(1)
        .to({ regX: 6.8, rotation: 54.7, x: -16.2, y: 60.3 }, 0)
        .wait(1)
        .to({ regX: 6.7, rotation: -10.5, x: -4.2, y: 102.3 }, 0)
        .wait(1),
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_1)
        .wait(1)
        .to({ rotation: -66.4, x: 23.3, y: 64.3 }, 0)
        .wait(1)
        .to({ rotation: -191.8, x: 29.6, y: 86.2 }, 0)
        .wait(1),
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_2)
        .wait(1)
        .to({ rotation: 100, x: -1.4, y: 80.1 }, 0)
        .wait(1)
        .to({ rotation: 49.5, x: -5.9, y: 88.8 }, 0)
        .wait(1),
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_3)
        .wait(1)
        .to({ rotation: 51.4, x: 26.9, y: 42.6 }, 0)
        .wait(1)
        .to({ rotation: 90, x: 19.8, y: 95.6 }, 0)
        .wait(1),
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_4)
        .wait(1)
        .to({ rotation: -37, x: -11.9, y: 36.3 }, 0)
        .wait(1)
        .to({ regX: 6.8, regY: 13.7, rotation: 121.5, x: 49.2, y: 89.5 }, 0)
        .wait(1),
    );
  }).prototype = p = new cjs.MovieClip();
  p.nominalBounds = new cjs.Rectangle(0, 0, 13.5, 87.6);

  (lib.Dhakkan = function () {
    this.initialize();
  ...
  p.nominalBounds = new cjs.Rectangle(21.8, 63.9, 121.4, 298);
  ...
  (lib.Canonwithfire = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AgaAbQgMgLAAgQQAAgPAMgLQALgMAPAAQAPAAAMAMQAMALAAAPQAAAQgMALQgMAMgPAAQgPAAgLgMg",
      );
    ...
    this.shape_1.graphics
      ...
      .s()
      .p(
        "AiTCUQg+g9AAhXQAAhVA+g+QA+g+BVAAQBXAAA+A+QA9A+AABVQAABXg9A9Qg+A+hXAAQhVAAg+g+gAh0h1QgyAxABBEQgBBFAyAxQAxAxBDAAQBFAAAwgxQAygxAAhFQAAhEgygxQgwgxhFAAQhDAAgxAxg",
      );
    ...
    this.shape_2.graphics
      ...
      .s()
      .p(
        "AiECFQg3g3AAhOQAAhNA3g3QA3g3BNAAQBOAAA3A3QA3A3AABNQAABOg3A3Qg3A3hOAAQhNAAg3g3g",
      );
    ...
    this.shape_4.graphics
      ...
      .s()
      .p(
        "AiTCUQg+g9AAhXQAAhVA+g+QA9g+BWAAQBXAAA9A+QA+A+AABVQAABXg+A9Qg9A+hXAAQhWAAg9g+gAh1h1QgwAxgBBEQABBFAwAxQAxAxBEAAQBFAAAxgxQAwgxAAhFQAAhEgwgxQgxgxhFAAQhEAAgxAxg",
      );
    ...
    this.shape_6.graphics
      ...
      .s()
      .p(
        "AgMANQgHgFABgIQgBgGAHgHQAGgFAGgBQAIABAGAFQAFAHAAAGQAAAIgFAFQgGAHgIAAQgGAAgGgHg",
      );
    ...
    this.shape_8.graphics
      ...
      .s()
      .p(
        "AgNANQgGgFAAgIQAAgGAGgHQAGgFAHgBQAIABAGAFQAGAHAAAGQAAAHgGAGQgGAHgIAAQgHAAgGgHg",
      );
    ...
    this.shape_9.graphics
      ...
      .s()
      .p(
        "AgNANQgGgFAAgIQAAgGAGgHQAGgFAHgBQAIABAGAFQAGAGAAAHQAAAIgGAFQgGAHgIAAQgHAAgGgHg",
      );
    ...
    this.shape_11.graphics
      ...
      .s()
      .p(
        "AgNANQgGgGAAgHQAAgGAGgHQAGgFAHgBQAIABAGAFQAGAHAAAGQAAAIgGAFQgGAHgIAAQgHAAgGgHg",
      );
    ...
    this.shape_12.graphics
      ...
      .s()
      .p(
        "AgNANQgFgFgBgIQABgGAFgHQAHgFAGgBQAIABAFAFQAHAHAAAGQAAAIgHAFQgFAHgIAAQgGAAgHgHg",
      );
    ...
    this.shape_13.graphics
      ...
      .s()
      .p(
        "AgNANQgFgFgBgIQABgGAFgHQAGgFAHgBQAIABAFAFQAHAHAAAGQAAAIgHAFQgFAHgIAAQgHAAgGgHg",
      );
    ...
    this.shape_14.graphics
      ...
      .s()
      .p(
        "AgMANQgHgFAAgIQAAgGAHgHQAFgFAHgBQAIABAGAFQAFAHABAGQgBAIgFAFQgGAHgIAAQgHAAgFgHg",
      );
    ...
    this.shape_15.graphics
      .f("#432C29")
      .s()
      .p("AtoAoQgKAAgIgIQgIgIAAgKIAAg0IcEAAIAAA0QAAAKgHAIQgIAIgLAAg");
    ...
    this.shape_16.graphics
      .f("#4C3431")
      .s()
      .p("AuCAoIAAg1QAAgKAIgIQAIgHAKAAIbQAAQALAAAIAHQAHAIAAAKIAAA1g");
    ...
    this.shape_17.graphics
      ...
      .s()
      .p(
        "AjXF3QgigUgKgmQgLgmAUgiIFQpIQAUgiAmgLQAmgKAiAUQAiATAKAmQAKAngTAiIlQJIQgUAigmALQgNADgMAAQgYAAgXgNg",
      );
    ...
    this.shape_18.graphics
      ...
      .s()
      .p(
        "ABQDVQgVgFgLgTIi6lEQgLgSAGgWQAFgVATgLQATgLAVAGQAVAGALATIC7FDQAKATgFAVQgGAVgTALQgNAHgNAAQgHAAgHgCg",
      );
    ...
    this.shape_19.graphics
      ...
      .s()
      .p(
        "Ag0EoQgXgXABgfIAAnjQgBgfAXgWQAWgXAeAAQAfAAAWAXQAXAWAAAfIAAHjQAAAfgXAXQgWAWgfAAQgeAAgWgWg",
      );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_13)
        ...
        .to({ x: 67.9, y: 28.5 }, 3)
        .wait(4)
        .to({ skewX: 56.4, skewY: 236.4, x: 58.5, y: 31.6 }, 6)
        .wait(17),
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_14)
        ...
        .to({ x: 58.7, y: 17.8 }, 3)
        .wait(4)
        .to({ regX: 11.3, skewX: 56.4, skewY: 236.4, x: 62.2, y: 17.9 }, 6)
        .wait(17),
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get({})
        .to({ state: [] })
        .to({ state: [{ t: this.instance_17 }, { t: this.instance_16 }] }, 1)
        .to({ state: [{ t: this.instance_16 }] }, 3)
        .to({ state: [{ t: this.instance_16 }] }, 3)
        .to({ state: [{ t: this.instance_16 }] }, 3)
        .to({ state: [{ t: this.instance_16 }] }, 3)
        .to({ state: [{ t: this.instance_16 }] }, 3)
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_18)
        ...
        .to({ x: 69.5, y: 23 }, 3)
        .wait(4)
        .to({ regX: 18, skewX: -41.5, skewY: 138.5, x: 71.3, y: 19.1 }, 6)
        .to({ regX: 18.1, skewX: 0, skewY: 180, x: 69.5, y: 23 }, 7)
        .to({ skewX: 56.7, skewY: 236.7, x: 60, y: 28.2 }, 6)
        .wait(4),
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_19)
        ...
        .to({ x: 61.1, y: 15.2 }, 3)
        .wait(4)
        .to({ skewX: -41.5, skewY: 138.5, x: 59.8, y: 19 }, 6)
        .to({ skewX: 0, skewY: 180, x: 61.1, y: 15.2 }, 7)
        .to({ skewX: 56.7, skewY: 236.7, x: 61.9, y: 16.9 }, 6)
        .wait(4),
    );
  }).prototype = p = new cjs.MovieClip();
  p.nominalBounds = new cjs.Rectangle(6.4, -1.7, 189.3, 98.6);

  (lib.Cannon_Iron = function () {
    this.initialize();
  ...
  p.nominalBounds = new cjs.Rectangle(-16, 16.6, 121.4, 301.8);
  ...
  (lib.Symbol8 = function () {
    ...
    this.shape.graphics
      .f("#FFFFFF")
      .s()
      .p("AFkDZIAAmxIAbAAIAAGxgAl+DZIAAmxIAZAAIAAGxg");
    this.shape.setTransform(352.9, 29);

    this.instance = new lib.Symbol4();
    this.instance.setTransform(297.7, 29.9, 1, 1, 0, 0, 0, 258.4, 25.2);
  ...
  p.nominalBounds = new cjs.Rectangle(-12, -17.5, 847, 96);
  ...
  (lib.canon2 = function () {
    ...
    this.shape_19.graphics
      ...
      .s()
      .p(
        "ACRGBQgmgLgUgiIlRpIQgUgiAKgmQAKgmAigUQAigTAnAKQAmAKATAiIFSJIQATAigKAmQgKAmgiAUQgXANgZAAQgMAAgMgDg",
      );
    ...
    this.shape_22.graphics
      ...
      .s()
      .p(
        "AiHBbQgFgEgBgGQgBgHAEgGQAEgGAHgBQBYgRBDgXQBFgVAHgNQAGgMgEgPQgDgNgIgFQgIgGgOAQQgFAFgHABQgHAAgFgFQgGgFAAgHQgBgHAFgFQAUgWAWgBQANAAAMAHQATAMAHAaQAGAagKAXQgMAbhhAfQg+AUhVARIgEAAQgGAAgFgEg",
      );
    ...
    this.shape_23.graphics
      ...
      .s()
      .p(
        "ApyHHIAArBQAegSAeATQA4AhAaAQQAbARAbAOIAdAPQBTApBPAWQAqAKAqAIQBbAOBWgMQArgHAsgNQCWgsCKh7IgHAJIA2gwQAsglAvg0QAcgfAegmQAAAEACAEIAAAFQAAALgCANIgEAtQAWAvAQAuIAALfg",
      );
    ...
    this.shape_24.graphics
      ...
      .s()
      .p(
        "AicFCQgqgIgqgKQhQgWhSgpIgegQQgagOgcgQQgZgRg4ggQgegTgeARIAAnYICoAAQARARAIANQBUCnA6BNQCsDfDugXQDxgWCrkAQAshCAhhLIAHgPIADgEIACAEIAJgTIgCGmQgQgugWgvIAEgrQACgNAAgLIAAgFQgCgEAAgEQgeAlgcAeQgvA0gsAlIg2AvIAHgJQiLB8iVAsQgsANgrAHQgnAFgpAAQgwAAgxgHg",
      );
  ...
  p.nominalBounds = new cjs.Rectangle(-13.7, -11.1, 138.1, 123.5);
  ...
  p.nominalBounds = new cjs.Rectangle(-20.6, 75.7, 162, 384.4);
  ...
  p.nominalBounds = new cjs.Rectangle(500, 1104.5, 1051, 114);
})(
  (lib = lib || {}),
  (images = images || {}),
  (createjs = createjs || {}),
