var Lab = (function () {
  ...
  function nextTurn() {
    ...
    this.layout.angleStepper.updateMinMax(
      360 -
        Math.max(
          this.activePlayer.arrow._minAngle,
          this.activePlayer.arrow._maxAngle,
        ),
      360 -
        Math.min(
          this.activePlayer.arrow._minAngle,
    ...
    if (!this.activePlayer.data("point1")) {
      ...
      var x1 = this.activePlayer.setTargets([
        200,
        160 - 40 * this.activePlayer.turn,
      ]);
