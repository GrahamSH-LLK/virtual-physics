var Lab = (function () {
  ...
  Activity.prototype.reset = function () {
    ...
    this.player1
      .data("Vx", this.player1.data("defaultVx"))
      .data("point0", false)
      .data("point1", false);
    this.player2
      .data("Vx", this.player2.data("defaultVx"))
      .data("point0", false)
      .data("point1", false);
  ...
  function createPlayers() {
    ...
    var a = new Slider(
      ...
      { direction: "left", lineWidth: BrowserDetect.any() ? 2 : 2 },
    );
    ...
    a = new Slider(
      ...
      {
        direction: "right",
        lineWidth: BrowserDetect.any() ? 2 : 2,
        color: "#FF992C",
      },
    );
    a.reverse = true;
...
Lab.data = {
  player1: {
    ...
    boundary: [
      [
        { x: sV(90 * 1.34), y: sV(434 * 1.34 + 5) },
        { x: sV(665 * 1.34), y: sV(434 * 1.34 + 5) },
      ],
      [
        { x: sV(665 * 1.34), y: sV(434 * 1.34 + 15) },
        { x: sV(641 * 1.34), y: sV(380 * 1.34 + 8) },
      ],
      [
        { x: sV(675 * 1.34), y: sV(434 * 1.34 + 15) },
        { x: sV(675 * 1.34), y: sV(382 * 1.34 + 15) },
      ],
      [
        { x: sV(667 * 1.34), y: sV(378 * 1.34 + 15) },
        { x: sV(667 * 1.34), y: sV(175 * 1.34 + 15) },
      ],
    ],
  },
  player2: {
    ...
    boundary: [
      [
        { x: sV(90 * 1.34), y: sV(434 * 1.34 + 1) },
        { x: sV(665 * 1.34), y: sV(434 * 1.34 + 5) },
      ],
      [
        { x: sV(122 * 1.34), y: sV(381 * 1.34 + 8) },
        { x: sV(95 * 1.34), y: sV(434 * 1.34 + 15) },
      ],
      [
        { x: sV(80 * 1.34), y: sV(371 * 1.34 + 15) },
        { x: sV(80 * 1.34), y: sV(434 * 1.34 + 15) },
      ],
      [
        { x: sV(94 * 1.34), y: sV(380 * 1.34 + 15) },
        { x: sV(92 * 1.34), y: sV(175 * 1.34 + 15) },
      ],
    ],
  },
};
