var Lab = (function () {
  ...
  Activity.prototype.reset = function () {
    ...
    this.layout.txtAy.text =
      this.layout.txtAx.text =
      this.layout.txtVy.text =
      this.layout.txtVx.text =
        "---";
  ...
  function onDataChange(e) {
    ...
    this.layout.vSpeedStepper.value =
      (this.activePlayer.arrow.y / this.activePlayer.arrow.unit).toFixed(1) *
      -1;
  ...
  function hit(e) {
    ...
    var t = Math.abs((2 * this.layout.vSpeedStepper.value) / Model.g).toFixed(
      2,
    );
    // console.log(t)
    ...
    fire: function (bool) {
      if (arguments.length > 0) {
        ...
        var p = this.arrow._baseVector.add(
          Vector.components(31, this.arrow.angle * Maths.TO_RADIANS),
        );
        this.ball.x = p.x;
        this.ball.y = p.y;
