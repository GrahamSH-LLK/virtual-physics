var Lab = (function () {
  ...
  Activity.prototype.startLab = function () {
    ...
    this.layout.pauseButton
      .enable()
      .addEventListener("click", this._pauseClicked);
  ...
  Activity.prototype.reset = function () {
    ...
    createjs.Tween.get(scope.layout.startPop, { override: true }).to(
      { y: 705 },
      1000,
  ...
  function clearpopup() {
    createjs.Tween.get(scope.layout[this.currentPopup]).to(
      { y: 750 },
      1000,
      createjs.Ease.linear,
    );
  ...
  function checkAnswers(e) {
    ...
    if (this.first == true && this.second == true && this.third == true) {
      ...
      if (
        ...
        this._clearpopup();
        createjs.Tween.get(scope.layout.ABCPop, { override: true }).to(
          { y: 702 },
          1000,
          createjs.Ease.linear,
        );
        ...
        this._clearpopup();
        createjs.Tween.get(scope.layout.correctPop, { override: true }).to(
          { y: 702 },
          1000,
          createjs.Ease.linear,
        );
        ...
        this.a != this.ANSWER_A &&
        this.b != this.ANSWER_B &&
        this.c != this.ANSWER_C
      ) {
        this._clearpopup();
        createjs.Tween.get(scope.layout.ABCPop, { override: true }).to(
          { y: 702 },
        ...
        this._clearpopup();
        createjs.Tween.get(scope.layout.ABPop, { override: true }).to(
          { y: 702 },
          1000,
          createjs.Ease.linear,
        );
        ...
        this._clearpopup();
        createjs.Tween.get(scope.layout.ACPop, { override: true }).to(
          { y: 702 },
          1000,
          createjs.Ease.linear,
        );
        ...
        this._clearpopup();
        createjs.Tween.get(scope.layout.BCPop, { override: true }).to(
          { y: 702 },
          1000,
          createjs.Ease.linear,
        );
        ...
        this._clearpopup();
        createjs.Tween.get(scope.layout.APop, { override: true }).to(
          { y: 702 },
          1000,
          createjs.Ease.linear,
        );
        ...
        this._clearpopup();
        createjs.Tween.get(scope.layout.BPop, { override: true }).to(
          { y: 702 },
          1000,
          createjs.Ease.linear,
        );
        ...
        this._clearpopup();
        createjs.Tween.get(scope.layout.CPop, { override: true }).to(
          { y: 702 },
          1000,
          createjs.Ease.linear,
        );
  ...
  function moveBall() {
    ...
    if (this.collision == false) {
      this.layout.redBall.x =
        this.layout.redBall.x +
        this.balls.redBall.beforeVelocity * this.CONVERT_PIXEL * this.TIMESTEP;
      this.layout.greenBall.x =
        this.layout.greenBall.x +
        this.balls.greenBall.beforeVelocity *
          this.CONVERT_PIXEL *
          this.TIMESTEP;
      this.layout.purpleBall.x =
        this.layout.purpleBall.x +
        this.balls.purpleBall.beforeVelocity *
          this.CONVERT_PIXEL *
          this.TIMESTEP;
      this.layout.blueBall.x =
        this.layout.blueBall.x +
        this.balls.blueBall.beforeVelocity * this.CONVERT_PIXEL * this.TIMESTEP;
      this.layout.brownBall.x =
        this.layout.brownBall.x +
        this.balls.brownBall.beforeVelocity *
          this.CONVERT_PIXEL *
          this.TIMESTEP;
      this.layout.greyBall.x =
        this.layout.greyBall.x +
        this.balls.greyBall.beforeVelocity * this.CONVERT_PIXEL * this.TIMESTEP;

      this.layout.redBallV.text = this.balls.redBall.beforeVelocity.toFixed(2);
      this.layout.greenBallV.text =
        this.balls.greenBall.beforeVelocity.toFixed(2);
      this.layout.purpleBallV.text =
        this.balls.purpleBall.beforeVelocity.toFixed(2);
      this.layout.blueBallV.text =
        this.balls.blueBall.beforeVelocity.toFixed(2);
      this.layout.brownBallV.text =
        this.balls.brownBall.beforeVelocity.toFixed(2);
      this.layout.greyBallV.text =
        this.balls.greyBall.beforeVelocity.toFixed(2);
    } else {
      this.layout.redBall.x =
        this.layout.redBall.x +
        this.balls.redBall.afterVelocity * this.CONVERT_PIXEL * this.TIMESTEP;
      this.layout.greenBall.x =
        this.layout.greenBall.x +
        this.balls.greenBall.afterVelocity * this.CONVERT_PIXEL * this.TIMESTEP;
      this.layout.purpleBall.x =
        this.layout.purpleBall.x +
        this.balls.purpleBall.afterVelocity *
          this.CONVERT_PIXEL *
          this.TIMESTEP;
      this.layout.blueBall.x =
        this.layout.blueBall.x +
        this.balls.blueBall.afterVelocity * this.CONVERT_PIXEL * this.TIMESTEP;
      this.layout.brownBall.x =
        this.layout.brownBall.x +
        this.balls.brownBall.afterVelocity * this.CONVERT_PIXEL * this.TIMESTEP;
      this.layout.greyBall.x =
        this.layout.greyBall.x +
        this.balls.greyBall.afterVelocity * this.CONVERT_PIXEL * this.TIMESTEP;

      this.layout.redBallV.text = this.balls.redBall.afterVelocity.toFixed(2);
      this.layout.greenBallV.text =
        this.balls.greenBall.afterVelocity.toFixed(2);
      this.layout.purpleBallV.text =
        this.balls.purpleBall.afterVelocity.toFixed(2);
      this.layout.blueBallV.text = this.balls.blueBall.afterVelocity.toFixed(2);
      this.layout.brownBallV.text =
        this.balls.brownBall.afterVelocity.toFixed(2);
