var Lab = (function () {
  ...
  Activity.prototype.reset = function () {
    ...
    createjs.Tween.get(scope.layout.popup, { override: true }).to(
      { y: 705 },
      1000,
  ...
  function moveBall() {
    ...
    if (this.collision == 0) {
      ...
      this.layout.blueBall.x =
        this.layout.blueBall.x +
        this.blueVelocity * this.CONVERT_PIXEL * this.TIMESTEP;
      this.layout.redBall.x =
        this.layout.redBall.x +
        this.redVelocity * this.CONVERT_PIXEL * this.TIMESTEP;
      ...
      if (!this._calculated) {
        ...
        this.redVelocity =
          (2 * this.BLUE_MASS * this.currentBlue -
            this.MASS_DIFF * this.currentRed) /
          this.TOTAL_MASS;
        this.blueVelocity =
          (this.MASS_DIFF * this.currentBlue) / this.TOTAL_MASS +
          (2 * this.RED_MASS * this.currentRed) / this.TOTAL_MASS;
        this.blueMomentum = this.BLUE_MASS * this.blueVelocity;
        this.redMomentum = this.RED_MASS * this.redVelocity;
  ...
  function playClicked(e) {
    ...
    this.layout.stepper1.enable();
    this.layout.stepper2.enable();
    createjs.Tween.get(scope.layout.popup).to(
      { y: 760 },
      1000,
      createjs.Ease.linear,
    );
