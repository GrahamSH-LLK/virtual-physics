  ...
  function moveBall() {
    ...
    if (this.collision == false) {
      this.layout.greenBall.x =
        this.layout.greenBall.x + 0.6 * this.CONVERT_PIXEL * this.TIMESTEP;
      this.layout.brownBall.x =
        this.layout.brownBall.x + -1 * this.CONVERT_PIXEL * this.TIMESTEP;
      ...
      this.layout.greenBall.x =
        this.layout.greenBall.x + -0.6 * this.CONVERT_PIXEL * this.TIMESTEP;
      this.layout.brownBall.x =
        this.layout.brownBall.x + 0.2 * this.CONVERT_PIXEL * this.TIMESTEP;
