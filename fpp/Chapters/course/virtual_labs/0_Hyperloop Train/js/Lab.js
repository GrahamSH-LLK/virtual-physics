...
var control = function () {
  ...
  function crash() {
    ...
    // });
    if (direction == 0) {
      createjs.Tween.get(lab.layout.engine, { override: true }).to(
        { x: lab.layout.engine.x + 13, y: lab.layout.engine.y + 13 },
        150,
        createjs.Ease.linear,
      );
      createjs.Tween.get(lab.layout.coach1, { override: true }).to(
        {
          rotation: lab.layout.coach1.rotation + 10,
          x: lab.layout.coach1.x + 28,
          y: lab.layout.coach1.y + 15,
        },
        150,
        createjs.Ease.linear,
      );
      createjs.Tween.get(lab.layout.coach2, { override: true })
        .to(
          {
            rotation: lab.layout.coach2.rotation - 6,
            x: lab.layout.coach2.x + 38,
            y: lab.layout.coach2.y + 6,
          },
          250,
          createjs.Ease.linear,
        )
      ...
      createjs.Tween.get(lab.layout.engine, { override: true }).to(
        { x: lab.layout.engine.x - 10, y: lab.layout.engine.y + 10 },
        150,
        createjs.Ease.linear,
      );
      createjs.Tween.get(lab.layout.coach1, { override: true }).to(
        {
          rotation: lab.layout.coach1.rotation - 10,
          x: lab.layout.coach1.x - 22,
          y: lab.layout.coach1.y + 12,
        },
        150,
        createjs.Ease.linear,
      );
      createjs.Tween.get(lab.layout.coach2, { override: true })
        .to(
          {
            rotation: lab.layout.coach2.rotation - 8,
            x: lab.layout.coach2.x - 25,
            y: lab.layout.coach2.y,
          },
          150,
          createjs.Ease.linear,
        )
  ...
  function startConditions() {
    if (this.finalVelocity != 0) {
      this.velocityX = 0;
      this.accelerationX =
        (0.5 * (this.finalVelocity * this.finalVelocity)) / 23.5;
      if (this.name == "engine") {
        lab.layout.speedometer2.value = this.accelerationX * 10;
      }
