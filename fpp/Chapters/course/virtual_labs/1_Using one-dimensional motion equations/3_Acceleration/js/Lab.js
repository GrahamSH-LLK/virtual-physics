var Lab = (function () {
  ...
  Activity.prototype.reset = function () {
    ...
    this.layout.PositionValue.text = (0).toFixed(2) + " m/s";
    Model.velocityX = 0;
    Model.velocityY = 0;
    scope.velocity = 0;
    Model.timer = null;
  ...
  function resetStage() {
    ...
    scope.layout.PositionValue.text = (0).toFixed(2) + " m/s";
  ...
  function updateTimer() {
    ...
    scope.layout.PositionValue.text = Model.velocityX.toFixed(2) + " m/s";
  }
