  ...
  function enterFrame() {
    for (var ll = 0; ll < 2; ll++) {
      ...
      if (this._first == false) {
        ...
        if (this._curTime >= 100) this.layout.timerTxt.x = 175;
      ...
      for (; i < this._waveEnd; i++) {
        if (this._first == false) {
          //console.log("this._phaseArray[0]==="+this._phaseArray[0]);
      ...
      this.layout.waveshape.graphics
        ...
        .beginStroke("#000")
        .moveTo(0, 0);
      //console.log("childIndex=="+this.stage.getNumChildren());
      //this.stage.setChildIndex(this.layout.birdscontainer,1000);
      //this.stage.setChildIndex(this.layout.parrot, 1000);
      //this.stage.setChildIndex(this.layout.waveshape, this.stage.getNumChildren()-3);
