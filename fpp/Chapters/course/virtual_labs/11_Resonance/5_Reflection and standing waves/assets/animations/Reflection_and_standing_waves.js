(function (lib, img, cjs, ss) {
  ...
  (lib.part_2 = function () {
    ...
    this.shape.graphics
      .f("#641A00")
      .s()
      .p("EgGZApcMAAAhS3ILwAAIAAAwMAAAAwzIAADJIAAB6IAAAMIAADmIBDAAIAAYfg");
  ...
  (lib.Bg = function () {
    ...
    this.shape_1.graphics
      ...
      .s()
      .p(
        "AjjBmQgrgqAAg8IABgKQAEg1AmglQArgrA7AAIAYgBIgTAVIgFAAQgyAAglAlQghAggDAsIgBAKQAAAzAlAlQAlAlAyAAQA0AAAkglQAlglAAgzQAAgOgDgPIgBgEIESAAIAAAfIjoACIAAAAIgTAAIAAAAQAAA8gpAqQgqAsg9gBQg7ABgrgsg",
      );
    ...
    this.shape_2.graphics
      ...
      .s()
      .p(
        "AjoB3QgygxAAhGIABgLQAEg+AtgtQAxgyBHAAIAEAAIATAXIgXABQg8AAgrArQgmAlgEA1IAAALQAAA7AqAqQArAsA8gBQA8ABAqgsQApgqAAg7IAAAAIATAAIAAgBIDpgCIAAAdIjlAAQgIA2gpAnQgvAyhGAAQhHAAgxgyg",
      );
    ...
    this.shape_3.graphics
      ...
      .s("#000000")
      .ss(1, 1, 1)
      .p("AE5hMIAABMIpxAAAE5BNIAAhNAk4hMIAABMIAABN");
