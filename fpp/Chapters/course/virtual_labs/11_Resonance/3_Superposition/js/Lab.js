...
var Lab = (function () {
      ...
      for (k = 0; k < m; k++) {
        ...
        if (
          ...
          if (scope._curTime > 0) {
            ...
            scope._waveEnd2 += 6;
            scope._waveStart2 += 6;
            if (scope._waveStart2 > scope._points.length - 1)
  ...
  function enterFrame(e, val) {
    ...
    for (var ll = 0; ll < _ll; ll++) {
      ...
      if (pAtStart) {
        this._thetaAtStart =
          2 * Math.PI * this._F1 * (pAtStart.x + this._phase1);
      }
      ...
      if (this._thetaAtStart <= -1 * Math.PI && this._ampChange == false)
        this._waveStart += 3;
      ...
      for (; i < this._waveEnd; i++) {
        ...
        if (p) {
          p.y =
            this._A1 * Math.sin(2 * Math.PI * this._F1 * (p.x + this._phase1));
      ...
      if (this._thetaAtStart2 >= Math.PI && this._ampChange == false) {
        this._waveStart2 -= 3;
      }
