(function (lib, img, cjs, ss) {
  ...
  (lib.Symbol2 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "",
      );
  ...
  (lib.Redball = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AAtA0IAAg/QAAgFgCgFQgDgFgIAAQgHAAgDAEQgDAEgCAEIAAAJIAAA5IggAAIAAg/IgBgHQgBgDgDgCQgDgDgFAAQgGAAgEADQgDADgCAEQgBAEAAAGIAAA6IgiAAIAAhlIAeAAIACAOQADgHAHgFQAHgEALAAQAJAAAHAEQAFADAEALQAFgIAIgFQAJgGAOABQAJAAAIADQAIADAGAIQAFAJAAARIAAA/g",
      );
  ...
  (lib.Greenball = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AAtA0IAAg/QAAgFgCgFQgDgFgIAAQgHAAgDAEQgDADgCAFIAAAJIAAA5IggAAIAAg/IgBgHQgBgDgDgCQgDgDgFAAQgGAAgEADQgDADgCAEQgBAEAAAFIAAA7IgiAAIAAhlIAeAAIACAOQADgHAHgFQAHgEALgBQAJABAHAEQAFAEAEAJQAFgHAIgFQAJgGAOAAQAJABAIADQAIADAGAIQAFAKAAAQIAAA/g",
      );
    ...
    this.shape_1.graphics
      ...
      .s()
      .p(
        "AguBHIAAgbIAvgqIALgLQAEgFAAgIQAAgEgCgFQgCgEgFgDQgFgDgGAAQgGAAgHACIgNAFIgKAEIgLgaQAMgHAOgEQANgDAMAAQAPAAAMAGQAMAFAGALQAHAKAAAOQAAAMgEAHQgEAGgHAIIgPANIgWATIA0AAIAAAeg",
      );
  ...
  (lib.Blueball = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AAtA0IAAg/QAAgFgCgFQgDgFgIABQgHAAgDADQgDAEgCAEIAAAJIAAA5IggAAIAAg/IgBgHQgBgDgDgCQgDgCgFAAQgGAAgEACQgDADgCAEQgBAEAAAGIAAA6IgiAAIAAhlIAeAAIACAOQADgHAHgFQAHgEALAAQAJAAAHADQAFAEAEALQAFgIAIgFQAJgGAOABQAJAAAIACQAIAEAGAIQAFAJAAARIAAA/g",
      );
    ...
    this.shape_1.graphics
      ...
      .s()
      .p(
        "AAJBFIAAgcIhBAAIAAgZIBDhUIAgAAIAABSIAOAAIAAAbIgOAAIAAAcgAgWAOIAfAAIAAglg",
      );
