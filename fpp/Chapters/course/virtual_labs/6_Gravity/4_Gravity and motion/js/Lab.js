var Lab = (function () {
  ...
  Activity.prototype._updateView = function (e) {
    ...
    this._masses.forEach(function (m) {
      if (!m.started) m.updateState(this._masses);
    }, this);
  };
...
var MassObject = (function () {
  ...
  Class.prototype._moveObject = function () {
    this._velocityVec = this._velocityVec.add(
      this._accVec.multiply(this._deltaT),
    );
    ...
    allMasses.forEach(function (m) {
      ...
      if (collidedSO && this.started) {
        ...
        if (this.children.length != 0 || m.children.length == 0) {
          ...
          //this object must not be a parent and the other one must already be
  ...
  Class.prototype._displayForce = function (allMasses) {
      ...
      if (object2 != this && object2.active) {
        ...
        var f =
          (this.G *
            object2.mass *
            this.mass *
            (7.702398800599701e24 * 7.702398800599701e24)) /
          Math.pow(d, 2);
    ...
    this._arrow.magnitude = v.magnitude() / 1.05e63;
    ...
    this.labelCont.getChildByName("t2").text =
      "= " + o.number.toFixed(2) + " × 10";
  ...
  Class.prototype._checkRadii = function (otherSO) {
    ...
    for (var i = 0; i < otherSO.children.length; i++) {
      ...
      if (
        Maths.getDistance(this, otherSOChild) <=
        this.radius + otherSOChild.radius
      ) {
    ...
    for (var i = 0; i < this.children.length; i++) {
      ...
      if (
        Maths.getDistance(mySOChild, otherSO) <=
        mySOChild.radius + otherSO.radius
      ) {
      ...
      for (var j = 0; j < otherSO.children.length; j++) {
        ...
        if (
          Maths.getDistance(mySOChild, otherSOChild) <=
          mySOChild.radius + otherSOChild.radius
        ) {
  ...
  Object.defineProperty(Class.prototype, "x", {
    ...
    set: function (value) {
      ...
      if (this.labelCont.x + this._labelOffset.width >= stageWidth) {
        this.labelCont.x =
          this.x - this._labelOffset.x - this._labelOffset.width;
      }
    },
  });
