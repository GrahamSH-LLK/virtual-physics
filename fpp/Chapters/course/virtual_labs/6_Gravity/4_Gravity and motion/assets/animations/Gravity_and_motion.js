(function (lib, img, cjs, ss) {
  ...
  (lib.Symbol4 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "ARuD3Mgh9AAAIgXAAIgDAAIgCAAIj6AAQhkAAAAhkIAAgRIAAkNIAAgHQAAhkBkAAID8AAIADAAMAlMAAAQBkAAAABkIAAAHIAAENIAAARQAABkhkAAg",
      );
  ...
  (lib.Symbol2 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "Eg//ADZIAAmxMBZkAAAQBkAAAABkIAADpQAABkhkAAgEA89ACdQAyhGgBhZQAAhgg2hJIDHAAIAAFIgEAzvACdQAxhGABhZQgBhgg3hJICEAAQg4BJABBgQgBBZAyBGgEAqzACdQhkAAAAhkIAAiAQAAhkBkAAIBsAAQg4BJAABgQABBZAxBGg",
      );
  ...
  (lib.ClipGroup_1_1 = function (mode, startPosition, loop) {
    ...
    this.shape_1.graphics
      .rf(["#4AE0F5", "#004DD9"], [0, 1], 8.3, -9.8, 0, 8.3, -9.8, 37.8)
      .s()
      .p("AjWDXIAAmtIGtAAIAAGtg");
  ...
  (lib.Redball = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AAwA0IAAg5QAAgPgDgEQgDgHgIABQgGAAgFADQgFAEgDAGQgCAHAAANIAAAxIgZAAIAAg3QAAgOgCgFQgBgFgDgCQgDgBgGAAQgGAAgFADQgFAEgCAFQgDAHAAANIAAAyIgbAAIAAhlIAZAAIAAAOQAOgQATAAQAKAAAHADQAFAEAFAJQAHgJAIgEQAIgDAJAAQALgBAIAFQAIAEAEAKQADAGAAAPIAABAg",
      );
  ...
  (lib.Greenball = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "",
      );
  ...
  (lib.Symbol3 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "ADuE7IAAp1MAl7AAAQBkABAABjIAAGtQAABjhkABgEgprAE7QhhgDAAhhIAAmtQAAhjBkgBMAs9AAAIAAJ1g",
      );
  ...
  (lib.Blueball = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "",
      );
