var Lab = (function () {
  ...
  function createPlayers() {
    var scope = this,
      stepper = this.layout.distanceStepper;

    //this.layout.moonImg.snapToPixel = false;
    this.moon = new Slider(
      this.layout.moonImg,
      638,
      990,
      stepper._min,
  ...
  function calculateGravity() {
    ...
    if (_distance >= 1.0 && this.layout.tensValue.text.sup == 7) {
      _distance = _distance * 10;
    }
    var gravity =
      ((scope.layout.massValue.text * 5.97 * 6.67) / (_distance * _distance)) *
      10;
